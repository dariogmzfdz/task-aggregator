...
function da(a){a=["object"==typeof globalThis&&globalThis,a,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}throw Error("Cannot find global object");}var t=da(this);function u(a,b){if(b)a:{var c=t;a=a.split(".");for(var d=0;d<a.length-1;d++){var e=a[d];if(!(e in c))break a;c=c[e]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&ca(c,a,{configurable:!0,writable:!0,value:b})}}var ea;
...
function z(a,b){function c(){}c.prototype=b.prototype;a.X=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Yb=function(d,e,f){for(var h=Array(arguments.length-2),k=2;k<arguments.length;k++)h[k-2]=arguments[k];return b.prototype[e].apply(d,h)}};function A(){0!=ua&&(va[oa(this)]=this);this.s=this.s;this.o=this.o}var ua=0,va={};A.prototype.s=!1;A.prototype.qa=function(){if(!this.s&&(this.s=!0,this.N(),0!=ua)){var a=oa(this);if(0!=ua&&this.o&&0<this.o.length)throw Error(this+" did not empty its onDisposeCallbacks queue. This probably means it overrode dispose() or disposeInternal() without calling the superclass' method.");delete va[a]}};A.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};var wa=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if("string"===typeof a)return"string"!==typeof b||1!=b.length?-1:a.indexOf(b,0);for(var c=0;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1};function xa(a){var b=a.length;if(0<b){for(var c=Array(b),d=0;d<b;d++)c[d]=a[d];return c}return[]}
...
if(w.document&&E){var Ta=Ma();Sa=Ta?Ta:parseInt(Na,10)||void 0}else Sa=void 0;var Ua=Sa;function G(a,b){B.call(this,a?a.type:"");this.relatedTarget=this.g=this.target=null;this.button=this.screenY=this.screenX=this.clientY=this.clientX=0;this.key="";this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1;this.state=null;this.pointerId=0;this.pointerType="";this.i=null;if(a){var c=this.type=a.type,d=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement;this.g=b;if(b=a.relatedTarget){if(Ka){a:{try{Ea(b.nodeName);var e=!0;break a}catch(f){}e=
...
function eb(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.da&&f.listener==b&&f.capture==!!c&&f.ka==d)return e}return-1};var gb="closure_lm_"+(1E6*Math.random()|0),hb={},ib=0;function jb(a,b,c,d,e){if(d&&d.once)return kb(a,b,c,d,e);if(Array.isArray(b)){for(var f=0;f<b.length;f++)jb(a,b[f],c,d,e);return null}c=lb(c);return a&&a[Wa]?a.O(b,c,x(d)?!!d.capture:!!d,e):mb(a,b,c,!1,d,e)}
function mb(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var h=x(e)?!!e.capture:!!e,k=nb(a);k||(a[gb]=k=new db(a));c=k.add(b,c,d,h,f);if(c.proxy)return c;d=ob();c.proxy=d;d.src=a;d.listener=c;if(a.addEventListener)za||(e=h),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(pb(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");ib++;return c}
...
function Vb(a,b){if(!a.g)return b;if(!b)return null;try{var c=JSON.parse(b);if(c)for(a=0;a<c.length;a++)if(Array.isArray(c[a])){var d=c[a];if(!(2>d.length)){var e=d[1];if(Array.isArray(e)&&!(1>e.length)){var f=e[0];if("noop"!=f&&"stop"!=f&&"close"!=f)for(var h=1;h<e.length;h++)e[h]=""}}}return vb(c)}catch(k){return b}};var L={},Xb=null;function Yb(){return Xb=Xb||new H}L.Ra="serverreachability";function Zb(a){B.call(this,L.Ra,a)}z(Zb,B);function $b(a){var b=Yb();I(b,new Zb(b,a))}L.STAT_EVENT="statevent";function ac(a,b){B.call(this,L.STAT_EVENT,a);this.stat=b}z(ac,B);function N(a){var b=Yb();I(b,new ac(b,a))}L.Sa="timingevent";function bc(a,b){B.call(this,L.Sa,a);this.size=b}z(bc,B);
function cc(a,b){if("function"!==typeof a)throw Error("Fn must not be null and must be a function");return w.setTimeout(function(){a()},b)};var dc={NO_ERROR:0,ob:1,Bb:2,Ab:3,vb:4,zb:5,Cb:6,Oa:7,TIMEOUT:8,Fb:9};var ec={tb:"complete",Pb:"success",Pa:"error",Oa:"abort",Hb:"ready",Ib:"readystatechange",TIMEOUT:"timeout",Db:"incrementaldata",Gb:"progress",wb:"downloadprogress",Xb:"uploadprogress"};function fc(){}fc.prototype.h=null;function gc(a){return a.h||(a.h=a.i())};function hc(){}var ic={OPEN:"a",sb:"b",Pa:"c",Eb:"d"};function jc(){B.call(this,"d")}z(jc,B);function kc(){B.call(this,"c")}z(kc,B);var lc;function mc(){}z(mc,fc);mc.prototype.g=function(){return new XMLHttpRequest};mc.prototype.i=function(){return{}};lc=new mc;function nc(a,b,c,d){this.l=a;this.j=b;this.m=c;this.W=d||1;this.U=new Ob(this);this.P=oc;a=Ja?125:void 0;this.V=new Ib(a);this.H=null;this.i=!1;this.s=this.A=this.v=this.L=this.F=this.Y=this.B=null;this.D=[];this.g=null;this.C=0;this.o=this.u=null;this.$=-1;this.J=!1;this.O=0;this.M=null;this.ba=this.K=this.aa=this.R=!1;this.h=new pc}function pc(){this.i=null;this.g="";this.h=!1}var oc=45E3,qc={},rc={};n=nc.prototype;n.setTimeout=function(a){this.P=a};
function sc(a,b,c){a.L=1;a.v=tc(O(b));a.s=c;a.R=!0;uc(a,null)}function uc(a,b){a.F=Date.now();vc(a);a.A=O(a.v);var c=a.A,d=a.W;Array.isArray(d)||(d=[String(d)]);wc(c.i,"t",d);a.C=0;c=a.l.H;a.h=new pc;a.g=xc(a.l,c?b:null,!a.s);0<a.O&&(a.M=new J(y(a.Na,a,a.g),a.O));Qb(a.U,a.g,"readystatechange",a.kb);b=a.H?ab(a.H):{};a.s?(a.u||(a.u="POST"),b["Content-Type"]="application/x-www-form-urlencoded",a.g.fa(a.A,a.u,a.s,b)):(a.u="GET",a.g.fa(a.A,a.u,null,b));$b(1);Tb(a.j,a.u,a.A,a.m,a.W,a.s)}
n.kb=function(a){a=a.target;var b=this.M;b&&3==P(a)?b.l():this.Na(a)};
n.Na=function(a){try{if(a==this.g)a:{var b=P(this.g),c=this.g.Ha(),d=this.g.ca();if(!(3>b)&&(3!=b||Ja||this.g&&(this.h.h||this.g.ia()||yc(this.g)))){this.J||4!=b||7==c||(8==c||0>=d?$b(3):$b(2));zc(this);var e=this.g.ca();this.$=e;b:if(Ac(this)){var f=yc(this.g);a="";var h=f.length,k=4==P(this.g);if(!this.h.i){if("undefined"===typeof TextDecoder){Q(this);Bc(this);var l="";break b}this.h.i=new w.TextDecoder}for(c=0;c<h;c++)this.h.h=!0,a+=this.h.i.decode(f[c],{stream:k&&c==h-1});f.splice(0,h);this.h.g+=
a;this.C=0;l=this.h.g}else l=this.g.ia();this.i=200==e;Ub(this.j,this.u,this.A,this.m,this.W,b,e);if(this.i){if(this.aa&&!this.K){b:{if(this.g){var m,p=this.g;if((m=p.g?p.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!Aa(m)){var r=m;break b}}r=null}if(e=r)K(this.j,this.m,e,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Cc(this,e);else{this.i=!1;this.o=3;N(12);Q(this);Bc(this);break a}}this.R?(Dc(this,b,l),Ja&&this.i&&3==b&&(Qb(this.U,this.V,"tick",this.jb),this.V.start())):
...
c,"[Invalid Chunked Response]"),Q(a),Bc(a))}n.jb=function(){if(this.g){var a=P(this.g),b=this.g.ia();this.C<b.length&&(zc(this),Dc(this,a,b),this.i&&4!=a&&vc(this))}};function Gc(a,b){var c=a.C,d=b.indexOf("\n",c);if(-1==d)return rc;c=Number(b.substring(c,d));if(isNaN(c))return qc;d+=1;if(d+c>b.length)return rc;b=b.substr(d,c);a.C=d+c;return b}n.cancel=function(){this.J=!0;Q(this)};function vc(a){a.Y=Date.now()+a.P;Ic(a,a.P)}
function Ic(a,b){if(null!=a.B)throw Error("WatchDog timer not null");a.B=cc(y(a.ib,a),b)}function zc(a){a.B&&(w.clearTimeout(a.B),a.B=null)}n.ib=function(){this.B=null;var a=Date.now();0<=a-this.Y?(Wb(this.j,this.A),2!=this.L&&($b(3),N(17)),Q(this),this.o=2,Bc(this)):Ic(this,this.Y-a)};function Bc(a){0==a.l.G||a.J||Ec(a.l,a)}function Q(a){zc(a);var b=a.M;b&&"function"==typeof b.qa&&b.qa();a.M=null;Jb(a.V);Rb(a.U);a.g&&(b=a.g,a.g=null,b.abort(),b.qa())}
function Cc(a,b){try{var c=a.l;if(0!=c.G&&(c.g==a||Jc(c.h,a)))if(!a.K&&Jc(c.h,a)&&3==c.G){try{var d=c.Ia.g.parse(b)}catch(Fc){d=null}if(Array.isArray(d)&&3==d.length){var e=d;if(0==e[0])a:{if(!c.u){if(c.g)if(c.g.F+3E3<a.F)Kc(c),Lc(c);else break a;Mc(c);N(18)}}else c.Ea=e[1],0<c.Ea-c.V&&37500>e[2]&&c.M&&0==c.A&&!c.v&&(c.v=cc(y(c.fb,c),6E3));if(1>=Nc(c.h)&&c.ma){try{c.ma()}catch(Fc){}c.ma=void 0}}else R(c,11)}else if((a.K||c.g==a)&&Kc(c),!Aa(b))for(e=c.Ia.g.parse(b),b=0;b<e.length;b++){var f=e[b];c.V=
...
n.Ya=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Bd(this)),this.g&&(this.readyState=3,Bd(this),this.g)))if("arraybuffer"===this.responseType)a.arrayBuffer().then(this.Wa.bind(this),this.ja.bind(this));else if("undefined"!==typeof w.ReadableStream&&"body"in a){this.j=a.body.getReader();if(this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=
[]}else this.response=this.responseText="",this.A=new TextDecoder;Dd(this)}else a.text().then(this.Xa.bind(this),this.ja.bind(this))};function Dd(a){a.j.read().then(a.Va.bind(a)).catch(a.ja.bind(a))}n.Va=function(a){if(this.g){if(this.u&&a.value)this.response.push(a.value);else if(!this.u){var b=a.value?a.value:new Uint8Array(0);if(b=this.A.decode(b,{stream:!a.done}))this.response=this.responseText+=b}a.done?Cd(this):Bd(this);3==this.readyState&&Dd(this)}};
n.Xa=function(a){this.g&&(this.response=this.responseText=a,Cd(this))};n.Wa=function(a){this.g&&(this.response=a,Cd(this))};n.ja=function(){this.g&&Cd(this)};function Cd(a){a.readyState=4;a.l=null;a.j=null;a.A=null;Bd(a)}n.setRequestHeader=function(a,b){this.v.append(a,b)};n.getResponseHeader=function(a){return this.h?this.h.get(a.toLowerCase())||"":""};
n.getAllResponseHeaders=function(){if(!this.h)return"";for(var a=[],b=this.h.entries(),c=b.next();!c.done;)c=c.value,a.push(c[0]+": "+c[1]),c=b.next();return a.join("\r\n")};function Bd(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(zd.prototype,"withCredentials",{get:function(){return"include"===this.m},set:function(a){this.m=a?"include":"same-origin"}});var Ed=w.JSON.parse;function X(a){H.call(this);this.headers=new Map;this.u=a||null;this.h=!1;this.C=this.g=null;this.H="";this.m=0;this.j="";this.l=this.F=this.v=this.D=!1;this.B=0;this.A=null;this.K=Fd;this.L=this.M=!1}z(X,H);var Fd="",Gd=/^https?$/i,Hd=["POST","PUT"];n=X.prototype;
...
n.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),Md(this,!0));X.X.N.call(this)};n.Ka=function(){this.s||(this.F||this.v||this.l?Nd(this):this.hb())};n.hb=function(){Nd(this)};
...
n.Ua=function(a){if(this.g){var b=this.g.responseText;a&&0==b.indexOf(a)&&(b=b.substring(a.length));return Ed(b)}};function yc(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.K){case Fd:case "text":return a.g.responseText;case "arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch(b){return null}}n.Ha=function(){return this.m};n.Qa=function(){return"string"===typeof this.j?this.j:String(this.j)};function Od(a){var b="";$a(a,function(c,d){b+=d;b+=":";b+=c;b+="\r\n"});return b}function Pd(a,b,c){a:{for(d in c){var d=!1;break a}d=!0}d||(c=Od(c),"string"===typeof a?(encodeURIComponent(String(b)),null!=c&&encodeURIComponent(String(c))):S(a,b,c))};function Qd(a,b,c){return c&&c.internalChannelParams?c.internalChannelParams[a]||b:b}
function Rd(a){this.Fa=0;this.i=[];this.j=new Sb;this.na=this.va=this.F=this.Y=this.g=this.Ca=this.D=this.la=this.o=this.U=this.s=null;this.cb=this.W=0;this.ab=Qd("failFast",!1,a);this.M=this.v=this.u=this.m=this.l=null;this.$=!0;this.sa=this.Ea=this.V=-1;this.aa=this.A=this.C=0;this.Za=Qd("baseRetryDelayMs",5E3,a);this.eb=Qd("retryDelaySeedMs",1E4,a);this.bb=Qd("forwardChannelMaxRetries",2,a);this.wa=Qd("forwardChannelRequestTimeoutMs",2E4,a);this.ua=a&&a.xmlHttpFactory||void 0;this.Ga=a&&a.ac||
!1;this.K=void 0;this.H=a&&a.supportsCrossDomainXhr||!1;this.J="";this.h=new pd(a&&a.concurrentRequestLimit);this.Ia=new ud;this.P=a&&a.fastHandshake||!1;this.O=a&&a.encodeInitMessageHeaders||!1;this.P&&this.O&&(this.O=!1);this.$a=a&&a.Zb||!1;a&&a.Da&&this.j.Da();a&&a.forceLongPolling&&(this.$=!1);this.ba=!this.P&&this.$&&a&&a.detectBufferingProxy||!1;this.ma=void 0;this.R=0;this.L=!1;this.oa=this.B=null}n=Rd.prototype;n.pa=8;n.G=1;
...
function Sd(a){Lc(a);a.u&&(w.clearTimeout(a.u),a.u=null);Kc(a);a.h.cancel();a.m&&("number"===typeof a.m&&w.clearTimeout(a.m),a.m=null)}function Sc(a){rd(a.h)||a.m||(a.m=!0,Db(a.Ma,a),a.C=0)}function Vd(a,b){if(Nc(a.h)>=a.h.j-(a.m?1:0))return!1;if(a.m)return a.i=b.D.concat(a.i),!0;if(1==a.G||2==a.G||a.C>=(a.ab?0:a.bb))return!1;a.m=cc(y(a.Ma,a,b),Wd(a,a.C));a.C++;return!0}
...
function Xd(a,b,c){c=Math.min(a.i.length,c);var d=a.l?y(a.l.Ta,a.l,a):null;a:for(var e=a.i,f=-1;;){var h=["count="+c];-1==f?0<c?(f=e[0].h,h.push("ofs="+f)):f=0:h.push("ofs="+f);for(var k=!0,l=0;l<c;l++){var m=e[l].h,p=e[l].g;m-=f;if(0>m)f=Math.max(0,e[l].h-100),k=!1;else try{vd(p,h,"req"+m+"_")}catch(r){d&&d(p)}}if(k){d=h.join("&");break a}}a=a.i.splice(0,c);b.D=a;return d}function Rc(a){a.g||a.u||(a.aa=1,Db(a.La,a),a.A=0)}
function Mc(a){if(a.g||a.u||3<=a.A)return!1;a.aa++;a.u=cc(y(a.La,a),Wd(a,a.A));a.A++;return!0}n.La=function(){this.u=null;Zd(this);if(this.ba&&!(this.L||null==this.g||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a);this.B=cc(y(this.gb,this),a)}};n.gb=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.M=!1,this.L=!0,N(10),Lc(this),Zd(this))};
function Hc(a){null!=a.B&&(w.clearTimeout(a.B),a.B=null)}function Zd(a){a.g=new nc(a,a.j,"rpc",a.aa);null===a.o&&(a.g.H=a.s);a.g.O=0;var b=O(a.va);S(b,"RID","rpc");S(b,"SID",a.J);S(b,"CI",a.M?"0":"1");S(b,"AID",a.V);S(b,"TYPE","xmlhttp");Td(a,b);a.o&&a.s&&Pd(b,a.o,a.s);a.K&&a.g.setTimeout(a.K);var c=a.g;a=a.na;c.L=1;c.v=tc(O(b));c.s=null;c.R=!0;uc(c,a)}n.fb=function(){null!=this.v&&(this.v=null,Lc(this),Mc(this),N(19))};function Kc(a){null!=a.v&&(w.clearTimeout(a.v),a.v=null)}
function Ec(a,b){var c=null;if(a.g==b){Kc(a);Hc(a);a.g=null;var d=2}else if(Jc(a.h,b))c=b.D,Qc(a.h,b),d=1;else return;if(0!=a.G)if(a.sa=b.$,b.i)if(1==d){c=b.s?b.s.length:0;b=Date.now()-b.F;var e=a.C;d=Yb();I(d,new bc(d,c,b,e));Sc(a)}else Rc(a);else if(e=b.o,3==e||0==e&&0<a.sa||!(1==d&&Vd(a,b)||2==d&&Mc(a)))switch(c&&0<c.length&&(b=a.h,b.i=b.i.concat(c)),e){case 1:R(a,5);break;case 4:R(a,10);break;case 3:R(a,6);break;default:R(a,2)}}
function Wd(a,b){var c=a.Za+Math.floor(Math.random()*a.eb);a.l||(c*=2);return c*b}function R(a,b){a.j.info("Error code "+b);if(2==b){var c=null;a.l&&(c=null);var d=y(a.mb,a);c||(c=new U("//www.google.com/images/cleardot.gif"),w.location&&"http"==w.location.protocol||Zc(c,"https"),tc(c));wd(c.toString(),d)}else N(2);a.G=0;a.l&&a.l.ya(b);Ud(a);Sd(a)}n.mb=function(a){a?(this.j.info("Successfully pinged google.com"),N(2)):(this.j.info("Failed to ping google.com"),N(1))};
...
*/
ae.prototype.createWebChannel=ae.prototype.g;Y.prototype.send=Y.prototype.u;Y.prototype.open=Y.prototype.m;Y.prototype.close=Y.prototype.close;dc.NO_ERROR=0;dc.TIMEOUT=8;dc.HTTP_ERROR=6;ec.COMPLETE="complete";hc.EventType=ic;ic.OPEN="a";ic.CLOSE="b";ic.ERROR="c";ic.MESSAGE="d";H.prototype.listen=H.prototype.O;X.prototype.listenOnce=X.prototype.P;X.prototype.getLastError=X.prototype.Qa;X.prototype.getLastErrorCode=X.prototype.Ha;X.prototype.getStatus=X.prototype.ca;X.prototype.getResponseJson=X.prototype.Ua;
X.prototype.getResponseText=X.prototype.ia;X.prototype.send=X.prototype.fa;module.exports.createWebChannelTransport=function(){return new ae};module.exports.getStatEventTarget=function(){return Yb()};module.exports.ErrorCode=dc;module.exports.EventType=ec;module.exports.Event=L;module.exports.Stat={ub:0,xb:1,yb:2,Rb:3,Wb:4,Tb:5,Ub:6,Sb:7,Qb:8,Vb:9,PROXY:10,NOPROXY:11,Ob:12,Kb:13,Lb:14,Jb:15,Mb:16,Nb:17,qb:18,pb:19,rb:20};module.exports.FetchXmlHttpFactory=yd;module.exports.WebChannel=hc;
module.exports.XhrIo=X;}).apply(typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {});
