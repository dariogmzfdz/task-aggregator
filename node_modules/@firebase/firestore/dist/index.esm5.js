...
import { FirebaseError as f, getUA as d, isSafari as p, getModularInstance as v, createMockUserToken as y, deepEqual as m, isIndexedDBAvailable as g } from "@firebase/util";

import { XhrIo as w, EventType as b, ErrorCode as I, createWebChannelTransport as E, getStatEventTarget as T, FetchXmlHttpFactory as S, WebChannel as D, Event as x, Stat as _ } from "@firebase/webchannel-wrapper";

var N = "@firebase/firestore", A = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
...
function L(t) {
    ...
    if (k.logLevel <= h.DEBUG) {
        var i = e.map(P);
        k.debug.apply(k, r([ "Firestore (" + C + "): " + t ], i));
    }
}

function R(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (k.logLevel <= h.ERROR) {
        var i = e.map(P);
        k.error.apply(k, r([ "Firestore (" + C + "): " + t ], i));
    }
}
 ...
 */ function M(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (k.logLevel <= h.WARN) {
        var i = e.map(P);
        k.warn.apply(k, r([ "Firestore (" + C + "): " + t ], i));
    }
}
 ...
 */ function F(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (" + C + ") INTERNAL ASSERTION FAILED: " + t;
 ...
 */ var G = {
    ...
    return t.prototype.start = function(t, r) {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                L("FirebaseAuthCredentialsProvider", "Auth not yet detected"), s.resolve(), s = new j);
            }
        }), 0), a();
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (q("string" == typeof n.accessToken), new Q(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.u = function() {
        ...
        return q(null === t || "string" == typeof t), new A(t);
    }, t;
}(), Y = /** @class */ function() {
    function t(t, e, n, r) {
        this.h = t, this.l = e, this.m = n, this.g = r, this.type = "FirstParty", this.user = A.FIRST_PARTY, 
        this.p = new Map
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(e).then((function(e) {
            return e ? (q("string" == typeof e.token), t.A = e.token, new Z(e.token)) : null;
        })) : Promise.resolve(null);
    }, t.prototype.invalidateToken = function() {
        this.forceRefresh = !0;
    }, t.prototype.shutdown = function() {
 ...
 */ var ot = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new K(G.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
...
}(st), ct = /^[_a-zA-Z][_a-zA-Z0-9]*$/, lt = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new K(G.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                ...
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new K(G.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
...
}(st), ht = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
    return t.fromPath = function(e) {
        return new t(at.fromString(e));
    }, t.fromName = function(e) {
        return new t(at.fromString(e).popFirst(5));
    }, t.empty = function() {
        return new t(at.emptyPath());
...
/** Returns all directional (ascending/descending) segments for this index. */ function pt(t) {
 ...
 * index ID.
 */ function vt(t, e) {
    var n = nt(t.collectionGroup, e.collectionGroup);
    if (0 !== n) return n;
    for (var r = 0; r < Math.min(t.fields.length, e.fields.length); ++r) if (0 !== (n = mt(t.fields[r], e.fields[r]))) return n;
    return nt(t.fields.length, e.fields.length);
}

/** Returns a debug representation of the field index */ ft.UNKNOWN_ID = -1;
...
function mt(t, e) {
    var n = lt.comparator(t.fieldPath, e.fieldPath);
    return 0 !== n ? n : nt(t.kind, e.kind);
}
 ...
 */ function wt(t, e) {
    ...
    var n = t.toTimestamp().seconds, r = t.toTimestamp().nanoseconds + 1, i = ut.fromTimestamp(1e9 === r ? new ot(n + 1, 0) : new ot(n, r));
    return new It(i, ht.empty(), e);
}

/** Creates a new offset based on the provided document. */ function bt(t) {
 ...
 */ var It = /** @class */ function() {
    ...
    return t.min = function() {
        return new t(ut.min(), ht.empty(), -1);
    }, 
    /** Returns an offset that sorts after all regular offsets. */ t.max = function() {
        return new t(ut.max(), ht.empty(), -1);
    }, t;
}();

function Et(t, e) {
    var n = t.readTime.compareTo(e.readTime);
    return 0 !== n ? n : 0 !== (n = ht.comparator(t.documentKey, e.documentKey)) ? n : nt(t.largestBatchId, e.largestBatchId);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Tt = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", St = /** @class */ function() {
    function t() {
...
function Dt(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== G.FAILED_PRECONDITION || t.message !== Tt) throw t;
 ...
 */ var xt = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.callbackAttached && F(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(n, this.error) : this.wrapSuccess(e, this.result) : new t((function(t, i) {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.P = new j, this.transaction.oncomplete = function() {
            n.P.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.P.reject(new Ct(t, e.error)) : n.P.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Rt(e.target.error);
            n.P.reject(new Ct(t, r));
        };
    }
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.D(d()) && R("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = n.sent(), r = _t.open(a.db, t, e ? "readonly" : "readwrite", i), s = o(r).next((function(t) {
                                    return r.V(), t;
                                })).catch((function(t) {
...
function Rt(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new K("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Lt || (Lt = !0, 
...
/** This class is responsible for the scheduling of Index Backfiller. */ var Mt = /** @class */ function() {
    function t(t, e) {
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return kt(i = n.sent()) ? (L("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", i), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
 ...
 */ var Ht = /** @class */ function() {
    ...
    t.prototype.unionWith = function(e) {
        for (var n = new Qt(lt.comparator), r = 0, i = this.fields; r < i.length; r++) {
            var o = i[r];
            n = n.add(o);
        }
...
/** True if and only if the Base64 conversion functions are available. */ function Yt() {
 ...
 */ function re(t) {
    var e = Jt(t.mapValue.fields.__local_write_time__.timestampValue);
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = Jt(t.timestampValue), r = Jt(e.timestampValue);
...
function pe(t, e) {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return ve(t.timestampValue, e.timestampValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return nt(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = nt($t(t.latitude), $t(e.latitude));
            return 0 !== n ? n : nt($t(t.longitude), $t(e.longitude));
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (var u = 0; u < r.length && u < o.length; ++u) {
                var s = nt(r[u], o[u]);
                if (0 !== s) return s;
                var a = pe(n[r[u]], i[o[u]]);
                if (0 !== a) return a;
            }
            return nt(r.length, o.length);
...
function ve(t, e) {
    ...
    var n = Jt(t), r = Jt(e), i = nt(n.seconds, r.seconds);
    return 0 !== i ? i : nt(n.nanos, r.nanos);
}
...
/** Creates a deep copy of `source`. */ function Se(t) {
    ...
    if (t.mapValue) {
        ...
        return Ut(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = Se(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Se(t.arrayValue.values[r]);
        return n;
    }
    return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function De(t) {
...
/** Returns the lowest value for the given value type (inclusive). */ function xe(t) {
    return "nullValue" in t ? le : "booleanValue" in t ? {
        ...
        bytesValue: ""
    } : "referenceValue" in t ? ge(oe.empty(), ht.empty()) : "geoPointValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
...
/** Returns the largest value for the given value type (exclusive). */ function _e(t) {
    return "nullValue" in t ? {
        ...
        bytesValue: ""
    } : "bytesValue" in t ? ge(oe.empty(), ht.empty()) : "referenceValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
 ...
 */ var Ce = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Te(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.set = function(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = Se(e);
    }, 
    /**
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Se(t) : i.push(o.lastSegment());
        }));
    ...
    t.prototype.delete = function(t) {
        ...
        Te(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }, t.prototype.isEqual = function(t) {
...
var Oe = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , ut.min(), ut.min(), Ce.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newFoundDocument = function(e, n, r) {
        return new t(e, 1 /* FOUND_DOCUMENT */ , n, ut.min(), r, 0 /* SYNCED */);
    }, 
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, ut.min(), Ce.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, ut.min(), Ce.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
    ...
    t.prototype.convertToNoDocument = function(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Ce.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }, 
    /**
    ...
    t.prototype.convertToUnknownDocument = function(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Ce.empty(), 
        this.documentState = 2 /* HAS_COMMITTED_MUTATIONS */ , this;
    }, t.prototype.setHasCommittedMutations = function() {
        return this.documentState = 2 /* HAS_COMMITTED_MUTATIONS */ , this;
    }, t.prototype.setHasLocalMutations = function() {
        return this.documentState = 1 /* HAS_LOCAL_MUTATIONS */ , this.version = ut.min(), 
        this;
...
function Re(t) {
    ...
    if (null === e.ht) {
        ...
        })).join(","), ue(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
/** Returns the field filters that target the given field path. */ function Fe(t, e) {
 ...
 */ function qe(t, e, n) {
    ...
    for (var r = le, i = !0, o = 0, u = Fe(t, e); o < u.length; o++) {
        var s = u[o], a = le, c = !0;
        switch (s.op) {
          case "<" /* LESS_THAN */ :
 ...
 */ function Ue(t, e, n) {
    // Process all filters to find a value for the current field segment
    for (var r = ce, i = !0, o = 0, u = Fe(t, e); o < u.length; o++) {
        var s = u[o], a = ce, c = !0;
        switch (s.op) {
          case ">=" /* GREATER_THAN_OR_EQUAL */ :
          case ">" /* GREATER_THAN */ :
...
/** Returns the number of segments of a perfect index for this target. */ var Be = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.lt(t, e, r) : new Ge(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ze(t, r) : "in" /* IN */ === e ? new We(t, r) : "not-in" /* NOT_IN */ === e ? new He(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ye(t, r) : new n(t, e, r);
    }, n.lt = function(t, e, n) {
        return "in" /* IN */ === e ? new Ke(t, n) : new je(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ft(pe(e, this.value)) : null !== e && he(this.value) === he(e) && this.ft(pe(e, this.value));
...
}((function() {})), Ge = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = ht.fromName(r.referenceValue), 
        i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = ht.comparator(t.key, this.key);
        return this.ft(e);
    }, n;
}(Be), Ke = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Qe("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Be), je = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Qe("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
function Qe(t, e) {
    ...
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((function(t) {
        return ht.fromName(t.referenceValue);
    }));
}
...
/** A Filter that implements the array-contains operator. */ var ze = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return be(e) && de(e.arrayValue, this.value);
    }, n;
}(Be), We = /** @class */ function(e) {
    function n(t, n) {
...
function $e(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? ht.comparator(ht.fromName(u.referenceValue), n.key) : pe(u, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function nn(t, e, n, r, i, o, u, s) {
 ...
 */ function cn(t) {
    ...
    if (null === e._t) {
        ...
        n.isKeyField() || e._t.push(new Ze(n)), e._t.push(new Ze(lt.keyField(), "asc" /* ASCENDING */)); else {
            ...
            if (!i) {
                ...
                e._t.push(new Ze(lt.keyField(), a));
            }
        }
    }
    return e._t;
 ...
 */ function ln(t) {
    var e = B(t);
    if (!e.wt) if ("F" /* First */ === e.limitType) e.wt = Le(e.path, e.collectionGroup, cn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new Xe(e.endAt.position, e.endAt.inclusive) : null, a = e.startAt ? new Xe(e.startAt.position, e.startAt.inclusive) : null;
...
function fn(t, e) {
    return Me(ln(t), ln(e)) && t.limitType === e.limitType;
}
...
function pn(t) {
    return "Query(target=" + function(t) {
        ...
        ue(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
 ...
 */
        ...
        }(t.startAt, cn(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = $e(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, cn(t), e));
    }(t, e);
...
function gn(t, e, n) {
    var r = t.field.isKeyField() ? ht.comparator(e.key, n.key) : function(t, e, n) {
        var r = e.data.field(t), i = n.data.field(t);
        return null !== r && null !== i ? pe(r, i) : F();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ function Tn(t, e, n) {
    ...
    }(n, e) : t instanceof _n ? Nn(t, e) : t instanceof An ? Cn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Dn(t, e), r = On(n) + On(t.yt);
        return we(n) && we(t.yt) ? bn(r) : wn(t.It, r);
    }(t, e);
}
 ...
 */ function Sn(t, e, n) {
    ...
    // applications.
    return t instanceof _n ? Nn(t, e) : t instanceof An ? Cn(t, e) : n;
}
 ...
 */ function Dn(t, e) {
    return t instanceof kn ? we(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ var An = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 */ function qn(t, e) {
    ...
    // mask is null when sets or deletes are applied to the current document.
        if (null === e) return t.isNoDocument() ? new Zn(t.key, Mn.none()) : new jn(t.key, t.data, Mn.none());
    for (var n = t.data, r = Ce.empty(), i = new Qt(lt.comparator), o = 0, u = e.fields; o < u.length; o++) {
        var s = u[o];
        if (!i.has(s)) {
            var a = n.field(s);
    ...
    return new Qn(t.key, r, new Ht(i.toArray()), Mn.none());
}
 ...
 */ function Un(t, e, n) {
    t instanceof jn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Wn(t.fieldTransforms, e, n.transformResults);
        ...
        if (Pn(t.precondition, e)) {
            var r = Wn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(zn(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Bn(t, e, n, r) {
    return t instanceof jn ? function(t, e, n, r) {
        ...
        return n;
        var i = t.value.clone(), o = Hn(t.fieldTransforms, r, e);
        return i.setAll(o), e.convertToFoundDocument(e.version, i).setHasLocalMutations(), 
        null;
        // SetMutation overwrites all fields.
        }(t, e, n, r) : t instanceof Qn ? function(t, e, n, r) {
        if (!Pn(t.precondition, e)) return n;
        var i = Hn(t.fieldTransforms, r, e), o = e.data;
        return o.setAll(zn(t)), o.setAll(i), e.convertToFoundDocument(e.version, o).setHasLocalMutations(), 
        null === n ? null : n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map((function(t) {
            return t.field;
        })));
    }(t, e, n, r) : function(t, e, n) {
        return Pn(t.precondition, e) ? (e.convertToNoDocument(e.version).setHasLocalMutations(), 
        null) : n;
    }(t, e, n);
}
 ...
 */ function Gn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        ...
        null != s && (null === n && (n = Ce.empty()), n.set(o.field, s));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && rt(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof _n && e instanceof _n || t instanceof An && e instanceof An ? rt(t.elements, e.elements, fe) : t instanceof kn && e instanceof kn ? fe(t.yt, e.yt) : t instanceof xn && e instanceof xn;
 ...
 */ function Hn(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(u.field, Tn(s, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Yn, Xn, Zn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function er(t) {
    ...
    return R("GRPC error has no .code"), G.UNKNOWN;
    switch (t) {
      case Yn.OK:
        return G.OK;
...
var or = new Gt(ht.comparator);

function ur() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = or, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.insert(o.key, o);
    }
    return n;
...
var hr = new Gt(ht.comparator), fr = new Qt(ht.comparator);
 ...
 */ var yr = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, mr.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(ut.min(), r, vr(), ir(), dr());
    }, t;
}(), mr = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Xt.EMPTY_BYTE_STRING, n, dr(), dr(), dr());
    }, t;
}(), gr = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = Xt.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    t.prototype.xt = function() {
        ...
        })), new mr(this.Pt, this.vt, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Nt = function() {
        this.Vt = !1, this.bt = Sr();
    ...
    t.prototype.Yt = function(t) {
        ...
        if (r) {
            ...
            if (Pe(i)) if (0 === n) {
                ...
                // queries.
                var o = new ht(i.path);
                this.jt(e, o, Oe.newNoDocument(o, ut.min()));
    ...
    t.prototype.te = function(t) {
        ...
        this.Lt.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Pe(o.target)) {
                    ...
                    var u = new ht(o.target.path);
                    null !== e.Ut.get(u) || e.ee(i, u) || e.jt(i, u, Oe.newNoDocument(u, t));
                }
        ...
        var i = new yr(t, n, this.Kt, this.Ut, r);
        return this.Ut = ir(), this.qt = Tr(), this.Kt = new Qt(nt), i;
    }, 
    /**
    ...
    t.prototype.Ot = function(t) {
        ...
        var e = this.Lt.get(t);
        return e || (e = new Ir, this.Lt.set(t, e)), e;
    }, t.prototype.ne = function(t) {
        var e = this.qt.get(t);
        return e || (e = new Qt(nt), this.qt = this.qt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Jt = function(t) {
        var e = this;
        this.Lt.set(t, new Ir), this.Bt.getRemoteKeysForTarget(t).forEach((function(n) {
...
function kr(t) {
    return q(!!t), ut.fromTimestamp(function(t) {
        var e = Jt(t);
        return new ot(e.seconds, e.nanos);
    }(t));
}
...
function Vr(t) {
    var e = at.fromString(t);
    return q(ei(e)), e;
}

function Lr(t, e) {
    return Or(t.databaseId, e.path);
}
...
function Pr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? at.emptyPath() : qr(e);
}
...
function Br(t, e, n) {
    var r = Rr(t, e.name), i = kr(e.updateTime), o = new Ce({
        mapValue: {
            fields: e.fields
        }
    }), u = Oe.newFoundDocument(r, i, o);
...
function Gr(t, e) {
    ...
    if (e instanceof jn) n = {
        update: Ur(t, e.key, e.value)
    }; else if (e instanceof Zn) n = {
        delete: Lr(t, e.key)
    }; else if (e instanceof Qn) n = {
        update: Ur(t, e.key, e.data),
        updateMask: ti(e.fieldMask)
    }; else {
        if (!(e instanceof Jn)) return F();
        n = {
            verify: Lr(t, e.key)
        };
    }
...
function Kr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Mn.updateTime(kr(t.updateTime)) : void 0 !== t.exists ? Mn.exists(t.exists) : Mn.none();
    }(e.currentDocument) : Mn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) q("REQUEST_TIME" === e.setToServerValue), n = new xn; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new _n(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new An(i);
            } else "increment" in e ? n = new kn(t, e.increment) : F();
            var o = lt.fromServerFormat(e.fieldPath);
            return new Ln(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Rr(t, e.update.name), o = new Ce({
            mapValue: {
        ...
        if (e.updateMask) {
            var u = function(t) {
                var e = t.fieldPaths || [];
                return new Ht(e.map((function(t) {
                    return lt.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new Qn(i, o, u, n, r);
        }
...
function Qr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Mr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Mr(t, r.popLast()), n.structuredQuery.from = [ {
...
function zr(t) {
    var e = Pr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        q(1 === r);
        var o = n.from[0];
    ...
    var u = [];
    n.where && (u = Wr(n.where));
    var s = [];
    n.orderBy && (s = n.orderBy.map((function(t) {
        return function(t) {
            return new Ze(Zr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return ue(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    ...
    return n.endAt && (l = function(t) {
        var e = !t.before, n = t.values || [];
        return new Xe(n, e);
    }(n.endAt)), nn(e, i, s, u, a, "F" /* First */ , c, l);
}

function Wr(t) {
    return t ? void 0 !== t.unaryFilter ? [ $r(t) ] : void 0 !== t.fieldFilter ? [ Jr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Wr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : F() : [];
...
function Jr(t) {
    return Be.create(Zr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function $r(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = Zr(t.unaryFilter.field);
        return Be.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Zr(t.unaryFilter.field);
 ...
 */ function ni(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = ii(e)), e = ri(t.get(n), e);
    return ii(e);
}
 ...
 */ function oi(t) {
    ...
    var e = t.length;
    if (q(e >= 2), 2 === e) return q("" === t.charAt(0) && "" === t.charAt(1)), at.emptyPath();
 ...
 * information.
 */ var ci = {}, li = [ "prefixPath", "collectionGroup", "readTime", "documentId" ], hi = [ "prefixPath", "collectionGroup", "documentId" ], fi = [ "collectionGroup", "readTime", "prefixPath", "documentId" ], di = [ "canonicalId", "targetId" ], pi = [ "targetId", "path" ], vi = [ "path", "targetId" ], yi = [ "collectionId", "parent" ], mi = [ "indexId", "uid" ], gi = [ "uid", "sequenceNumber" ], wi = [ "indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey" ], bi = [ "indexId", "uid", "orderedDocumentKey" ], Ii = [ "userId", "collectionPath", "documentId" ], Ei = [ "userId", "collectionPath", "largestBatchId" ], Ti = [ "userId", "collectionGroup", "largestBatchId" ], Si = r(r([], r(r([], r(r([], r(r([], [ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ]), [ "clientMetadata" ])), [ "remoteDocumentGlobal" ])), [ "collectionParents" ])), [ "bundles", "namedQueries" ]), Di = r(r([], Si), [ "documentOverlays" ]), xi = [ "mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays" ], _i = xi, Ni = r(r([], _i), [ "indexConfiguration", "indexState", "indexEntries" ]), Ai = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ var ki = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Un(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t, e) {
        ...
        // Second, apply all user-provided mutations.
            ...
            var s = u[o];
            s.key.isEqual(t.key) && (e = Bn(s, t, e, this.localWriteTime));
        }
        return e;
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t, e) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        null !== a && r.set(i.key, a), u.isValidDocument() || u.convertToNoDocument(ut.min());
        })), r;
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = hr, o = e.mutations, u = 0; u < o.length; u++) i = i.insert(o[u].key, r[u].version);
     ...
     * time from which the server should resume sending results.
     */ , u) {
        void 0 === i && (i = ut.min()), void 0 === o && (o = ut.min()), void 0 === u && (u = Xt.EMPTY_BYTE_STRING), 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Ui(t, e) {
    ...
    var u = e.mutations.map((function(e) {
        return Kr(t.re, e);
    })), s = ot.fromMillis(e.localWriteTimeMs);
    return new ki(e.batchId, s, n, u);
}

/** Decodes a DbTarget into TargetData */ function Bi(t) {
    var e, n, r = qi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? qi(t.lastLimboFreeSnapshotVersion) : ut.min();
    return void 0 !== t.query.documents ? (q(1 === (n = t.query).documents.length), 
    e = ln(rn(Pr(n.documents[0])))) : e = function(t) {
        return ln(zr(t));
    }(t.query), new Li(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Xt.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Gi(t, e) {
    var n, r = Fi(e.snapshotVersion), i = Fi(e.lastLimboFreeSnapshotVersion);
    n = Pe(e.target) ? jr(t.re, e.target) : Qr(t.re, e.target);
 ...
 */ function Ki(t) {
    ...
    return "LAST" === t.limitType ? hn(e, e.limit, "L" /* Last */) : e;
}

/** Encodes a NamedQuery proto object to a NamedQuery model object. */
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function ji(t, e) {
    return new Vi(e.largestBatchId, Kr(t.re, e.overlayMutation));
}
...
function zi(t, e, n, r) {
    return {
        ...
        uid: e.uid || "",
        sequenceNumber: n,
        readTime: Fi(r.readTime),
        documentKey: ni(r.documentKey.path),
 ...
 */ var Xi = /** @class */ function() {
    ...
    return t.oe = function(e, n) {
        ...
        var n = this;
        return Zi(t).get(Qi(this.userId, e)).next((function(t) {
            return t ? ji(n.It, t) : null;
        }));
        ...
        e.forEach((function(t) {
            return i.add(ni(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(Zi(t).Y("collectionPathOverlayIndex", i));
        })), xt.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = ar(), o = ni(e), u = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Zi(t).W("collectionPathOverlayIndex", u).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], u = ji(r.It, o);
                i.set(u.getKey(), u);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, u = ar(), s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Zi(t).Z({
        ...
        return Zi(t).put(function(t, e, n) {
            ...
            return r[0], {
                ...
                overlayMutation: Gr(t.re, n.mutation)
            };
...
/** Firestore index value writer.  */ var Ji = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.ce = function(t, e) {
        ...
        e.fe(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.le(e, 15), e.fe($t(t.integerValue)); else if ("doubleValue" in t) {
        ...
        e.me(te(t.bytesValue)), this.we(e); else if ("referenceValue" in t) this.ge(t.referenceValue, e); else if ("geoPointValue" in t) {
            var i = t.geoPointValue;
            this.le(e, 45), e.fe(i.latitude || 0), e.fe(i.longitude || 0);
        } else "mapValue" in t ? De(t) ? this.le(e, Number.MAX_SAFE_INTEGER) : (this.ye(t.mapValue, e), 
        this.we(e)) : "arrayValue" in t ? (this.pe(t.arrayValue, e), this.we(e)) : F();
        ...
        var n = this;
        this.le(e, 37), ht.fromName(t).path.forEach((function(t) {
            n.le(e, 60), n.Ie(t, e);
        }));
...
var eo = /** @class */ function() {
    ...
    function t() {
        this.Be = new eo, this.Le = new no(this.Be), this.Ue = new ro(this.Be);
    }
...
function uo(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = so(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = so(t.directionalValue, e.directionalValue)) ? n : ht.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var ao = /** @class */ function() {
     ...
     */    return t.prototype.We = function(t) {
        ...
        for (var n = pt(t), r = 0, i = 0; r < n.length && this.ze(n[r]); ++r) ;
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Qt(at.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Qt(at.comparator)).toArray();
    }, t;
}(), ho = new Uint8Array(0), fo = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ it(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return po(t).W(r).next((function(t) {
        ...
        if (e.indexState) {
            ...
            return o.next((function(t) {
                u.put(zi(t, n.user, e.indexState.sequenceNumber, e.indexState.offset));
            }));
        }
        return o.next();
    }, t.prototype.deleteFieldIndex = function(t, e) {
        var n = yo(t), r = mo(t), i = vo(t);
        ...
        var n = this, r = vo(t), i = !0, o = new Map;
        return xt.forEach(this.tn(e), (function(e) {
            ...
            if (i) {
                ...
                return xt.forEach(o, (function(i, o) {
                    ...
                    })).join(",") + " to execute ") + Re(e));
                    var a = function(t, e) {
                        var n = dt(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = Fe(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = pt(e); r < i.length; r++) for (var o = i[r], u = 0, s = Fe(t, o.fieldPath); u < s.length; u++) {
                            var a = s[u];
                            switch (a.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                        ...
                        // startAt.
                        for (var n = [], r = !0, i = 0, o = pt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? qe(t, u.fieldPath, t.startAt) : Ue(t, u.fieldPath, t.startAt);
                        ...
                        // endAt.
                        for (var n = [], r = !0, i = 0, o = pt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Ue(t, u.fieldPath, t.endAt) : qe(t, u.fieldPath, t.endAt);
                            n.push(s.value), r && (r = s.inclusive);
                        }
                        return new Xe(n, r);
                    ...
                    return xt.forEach(v, (function(n) {
                        return r.J(n, e.limit).next((function(e) {
                            e.forEach((function(e) {
                                var n = ht.fromSegments(e.documentKey);
    ...
    t.prototype.rn = function(t, e, n, r, i, o, u) {
        for (var s = this, a = (null != e ? e.length : 1) * Math.max(n.length, i.length), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.on(e[a / c]) : ho, d = f.un(t, h, n[a % c], r), p = f.cn(t, h, i[a % c], o), v = u.map((function(e) {
                return s.un(t, h, e, 
                /* inclusive= */ !0);
            }));
    ...
    /** Generates the upper bound for `arrayValue` and `directionalValue`. */ t.prototype.cn = function(t, e, n, r) {
        ...
        var n = new ao(e), r = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
        ...
        return xt.forEach(this.tn(e), (function(e) {
            return n.en(t, e).next((function(t) {
                t ? 0 /* NONE */ !== r && t.fields.length < function(t) {
                    for (var e = new Qt(lt.comparator), n = !1, r = 0, i = t.filters; r < i.length; r++) {
                        var o = i[r];
    ...
    t.prototype.an = function(t, e) {
        for (var n = new io, r = 0, i = pt(t); r < i.length; r++) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.on = function(t) {
        var e = new io;
        return Ji.Te.ce(t, e.qe(0 /* ASCENDING */)), e.$e();
    }, 
    /**
    ...
    t.prototype.hn = function(t, e) {
        var n = new io;
        return Ji.Te.ce(ge(this.databaseId, e), n.qe(function(t) {
            var e = pt(t);
    ...
    t.prototype.sn = function(t, e, n) {
        ...
        var r = [];
        r.push(new io);
        for (var i = 0, o = 0, u = pt(t); o < u.length; o++) for (var s = u[o], a = n[i++], c = 0, l = r; c < l.length; c++) {
            var h = l[c];
            if (this.ln(e, s.fieldPath) && be(a)) r = this.fn(r, s, a); else {
                var f = h.qe(s.kind);
                Ji.Te.ce(a, f);
            }
        }
    ...
    t.prototype.fn = function(t, e, n) {
        for (var i = r([], t), o = [], u = 0, s = n.arrayValue.values || []; u < s.length; u++) for (var a = s[u], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new io;
            f.seed(h.$e()), Ji.Te.ce(a, f.qe(e.kind)), o.push(f);
        }
        return o;
        ...
        return (e ? r.W("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.W()).next((function(t) {
            ...
            return xt.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new gt(e.sequenceNumber, new It(qi(e.readTime), new ht(oi(e.documentKey)), e.largestBatchId)) : gt.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
                            return new yt(lt.fromServerFormat(e), n);
                        }));
                        return new ft(t.indexId, t.collectionGroup, r, n);
                    }(t, n));
                }));
            })).next((function() {
                return e;
        ...
        return this.getFieldIndexes(t).next((function(t) {
            return 0 === t.length ? null : (t.sort((function(t, e) {
                ...
                return 0 !== n ? n : nt(t.collectionGroup, e.collectionGroup);
            })), t[0].collectionGroup);
        }));
    }, t.prototype.updateCollectionGroup = function(t, e, n) {
        var r = this, i = yo(t), o = mo(t);
        return this._n(t).next((function(t) {
            return i.W("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((function(e) {
                return xt.forEach(e, (function(e) {
                    return o.put(zi(e.indexId, r.user, t, n));
                }));
            }));
        }));
    }, t.prototype.updateIndexEntries = function(t, e) {
        ...
        return vo(t).delete([ r.indexId, this.uid, r.arrayValue, r.directionalValue, this.hn(n, e.key), e.key.path.toArray() ]);
    }, t.prototype.wn = function(t, e, n) {
        var r = vo(t), i = new Qt(uo);
        return r.Z({
    ...
    /** Creates the index entries for the given document. */ t.prototype.mn = function(t, e) {
        var n = new Qt(uo), r = this.an(e, t);
        if (null == r) return n;
        var i = dt(e);
        if (null != i) {
            var o = t.data.field(i.fieldPath);
            if (be(o)) for (var u = 0, s = o.arrayValue.values || []; u < s.length; u++) {
                var a = s[u];
                n = n.add(new oo(e.indexId, t.key, this.on(a), r));
            }
    ...
    t.prototype.gn = function(t, e, n, r, i) {
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), u = e.getIterator(), s = Wt(o), a = Wt(u); s || a; ) {
                var c = !1, l = !1;
                if (s && a) {
                    var h = n(s, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = Wt(u)) : l ? (i(s), s = Wt(o)) : (s = Wt(o), a = Wt(u));
            }
        }(r, i, uo, (
        /* onAdd= */ function(r) {
            u.push(o.yn(t, e, n, r));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        r.push(e);
        for (var c = [], l = 0; l < r.length; l += 2) c.push(IDBKeyRange.bound([ r[l].indexId, this.uid, r[l].arrayValue, r[l].directionalValue, ho, [] ], [ r[l + 1].indexId, this.uid, r[l + 1].arrayValue, r[l + 1].directionalValue, ho, [] ]));
        return c;
    }, t.prototype.getMinOffsetFromCollectionGroup = function(t, e) {
        return this.getFieldIndexes(t, e).next(go);
    }, t.prototype.getMinOffset = function(t, e) {
        var n = this;
 ...
 */
function po(t) {
    return Ci(t, "collectionParents");
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function vo(t) {
    return Ci(t, "indexEntries");
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function yo(t) {
    return Ci(t, "indexConfiguration");
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function mo(t) {
    return Ci(t, "indexState");
}
...
function Io(t, e, n) {
    ...
    for (var c = [], l = 0, h = n.mutations; l < h.length; l++) {
        var f = h[l], d = ai(e, f.key.path, n.batchId);
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ bo.DEFAULT_COLLECTION_PERCENTILE = 10, 
bo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, bo.DEFAULT = new bo(41943040, bo.DEFAULT_COLLECTION_PERCENTILE, bo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
bo.DISABLED = new bo(-1, 0, 0);
...
var To = /** @class */ function() {
    ...
    return t.oe = function(e, n, r, i) {
        ...
        return u.add({}).next((function(s) {
            q("number" == typeof s);
            for (var a = new ki(s, e, n, r), c = function(t, e, n) {
            ...
            }(i.It, i.userId, a), l = [], h = new Qt((function(t, e) {
                return nt(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], v = ai(i.userId, p.key.path, s);
                h = h.add(p.key.path.popLast()), l.push(u.put(c)), l.push(o.put(v, ci));
            }
        ...
        return Do(t).get(e).next((function(t) {
            return t ? (q(t.userId === n.userId), Ui(n.It, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Tn = function(t, e) {
        ...
        return Do(t).Z({
            ...
            e.userId === n.userId && (q(e.batchId >= r), o = Ui(n.It, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Do(t).W("userMutationsIndex", n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return Do(t).get(c).next((function(t) {
                if (!t) throw F();
                q(t.userId === n.userId), o.push(Ui(n.It, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Qt(nt), i = [];
        return e.forEach((function(e) {
            var o = si(n.userId, e.path), u = IDBKeyRange.lowerBound(o), s = xo(t).Z({
                range: u
            }, (function(t, i, o) {
                var u = t[0], s = t[1], a = t[2], c = oi(s);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
        ...
        var n = this, r = e.path, i = r.length + 1, o = si(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new Qt(nt);
        return xo(t).Z({
            range: u
        }, (function(t, e, o) {
            var u = t[0], a = t[1], c = t[2], l = oi(a);
        ...
        return e.forEach((function(e) {
            i.push(Do(t).get(e).next((function(t) {
                if (null === t) throw F();
                q(t.userId === n.userId), r.push(Ui(n.It, t));
            })));
        })), xt.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Io(t.ie, this.userId, e).next((function(r) {
    ...
    t.prototype.Rn = function(t) {
        var e = this;
        return _o(t).get(this.userId).next((function(t) {
            return t || {
                userId: e.userId,
 ...
 */ function Do(t) {
    return Ci(t, "mutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function xo(t) {
    return Ci(t, "documentMutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function _o(t) {
    return Ci(t, "mutationQueues");
}
 ...
 */ var No = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Vn(t).next((function(t) {
            return ut.fromTimestamp(new ot(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Co(t).Z((function(t, n) {
            var r = Bi(n);
            e(r);
        }));
    }, t.prototype.Vn = function(t) {
        return ko(t).get("targetGlobalKey").next((function(t) {
            return q(null !== t), t;
        }));
    }, t.prototype.Sn = function(t, e) {
        return ko(t).put("targetGlobalKey", e);
    }, t.prototype.Dn = function(t, e) {
        return Co(t).put(Gi(this.It, e));
    }, 
    /**
    ...
    t.prototype.Cn = function(t, e) {
        ...
        var n = Re(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Co(t).Z({
            range: r,
        ...
        var n = Oo(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Oo(t), i = dr();
        return r.Z({
            range: n,
            X: !0
        }, (function(t, e, n) {
            var r = oi(t[1]), o = new ht(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = ni(e.path), r = IDBKeyRange.bound([ n ], [ it(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Oo(t).Z({
 ...
 */ function ko(t) {
    return Ci(t, "targetGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Oo(t) {
    return Ci(t, "targetDocuments");
}
 ...
 * limitations under the License.
 */ function Vo(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], u = nt(n, i);
    return 0 === u ? nt(r, o) : u;
}
 ...
 */ var Lo = /** @class */ function() {
    function t(t) {
        this.xn = t, this.buffer = new Qt(Vo), this.Nn = 0;
    }
    ...
    return t.prototype.start = function() {
        ...
        var r = this;
        L("LruGarbageCollector", "Garbage collection scheduled in " + t + "ms"), this.On = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (function() {
            return e(r, void 0, void 0, (function() {
                var t;
                return n(this, (function(e) {
                    switch (e.label) {
                      ...
                      case 3:
                        return kt(t = e.sent()) ? (L("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        var n = this;
        if (0 === e) return xt.resolve(Ft.at);
        var r = new Lo(e);
    ...
    t.prototype.Gn = function(t, e) {
        return function(t, e) {
            var n = !1;
            return _o(t).tt((function(r) {
                return So(t, r, e).next((function(t) {
            ...
            if (s <= e) {
                var a = n.Gn(t, u).next((function(e) {
                    ...
                    return o++, r.getEntry(t, u).next((function() {
                        return r.removeEntry(u, ut.min()), Oo(t).delete([ 0, ni(u.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */
        function(t, e) {
            ...
            /* collection id */ n[n.length - 2], Pi(e), 
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this, r = Oe.newInvalidDocument(e);
        return jo(t).Z({
            index: "documentKeyIndex",
     ...
     */
    t.prototype.Hn = function(t, e) {
        var n = this, r = ir(), i = new Gt(ht.comparator);
        return this.zn(t, e, (function(t, e) {
            var o = n.jn(t, e);
        ...
        return jo(t).Z({
            ...
            for (var o = ht.fromSegments(r(r([], e.prefixPath), [ e.collectionGroup, e.documentId ])); s && Wo(s, o) < 0; ) n(s, null), 
            s = u.getNext();
            s && s.isEqual(o) && (
            // Key found in cache.
        ...
        var r = this, i = [ e.popLast().toArray(), e.lastSegment(), Pi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], o = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return jo(t).W(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = ir(), n = 0, i = t; n < i.length; n++) {
                var o = i[n], u = r.jn(ht.fromSegments(o.prefixPath.concat(o.collectionGroup, o.documentId)), o);
                e = e.insert(u.key, u);
            }
            return e;
        }));
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        var i = this, o = ir(), u = zo(e, n), s = zo(e, It.max());
        return jo(t).Z({
            index: "collectionGroupIndex",
            range: IDBKeyRange.bound(u, s, !0)
        }, (function(t, e, n) {
            var u = i.jn(ht.fromSegments(e.prefixPath.concat(e.collectionGroup, e.documentId)), e);
            (o = o.insert(u.key, u)).size === r && n.done();
        })).next((function() {
            return o;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Go(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Ko(t).get("remoteDocumentGlobalKey").next((function(t) {
            return q(!!t), t;
        }));
    }, t.prototype.Qn = function(t, e) {
        return Ko(t).put("remoteDocumentGlobalKey", e);
    }, 
    /**
    ...
    t.prototype.jn = function(t, e) {
        if (e) {
            ...
            /** Decodes a remote document from storage locally to a Document. */ function(t, e) {
                var n;
                if (e.document) n = Br(t.re, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
                    var r = ht.fromSegments(e.noDocument.path), i = qi(e.noDocument.readTime);
                    n = Oe.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
                } else {
                    if (!e.unknownDocument) return F();
                    var o = ht.fromSegments(e.unknownDocument.path), u = qi(e.unknownDocument.version);
                    n = Oe.newUnknownDocument(o, u);
                }
 ...
 */
/** Creates a new IndexedDbRemoteDocumentCache. */ function Bo(t) {
    return new Uo(t);
}
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, u) {
            ...
            if (n.push(e.Yn.removeEntry(t, o, s.readTime)), u.isValidDocument()) {
                ...
                var l = Mi(e.Yn.It, u.convertToNoDocument(ut.min()));
...
function Ko(t) {
    return Ci(t, "remoteDocumentGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function jo(t) {
    return Ci(t, "remoteDocumentsV14");
}
 ...
 */ function Wo(t, e) {
    ...
    ; o < n.length - 2 && o < r.length - 2; ++o) if (i = nt(n[o], r[o])) return i;
    return (i = nt(n.length, r.length)) || ((i = nt(n[n.length - 2], r[r.length - 2])) || nt(n[n.length - 1], r[r.length - 1]));
}
...
e) {
    ...
    return t.prototype.getDocument = function(t, e) {
        ...
        return this.documentOverlayCache.getOverlay(t, e).next((function(i) {
            ...
            return null !== r && Bn(r.mutation, t, Ht.empty(), ot.now()), t;
        }));
    }, 
    /**
    ...
    t.prototype.computeViews = function(t, e, n, r) {
        ...
        return e.forEach((function(t, e) {
            ...
            // change (hence overlay is undefined), but would now match.
                        r.has(e.key) && (void 0 === u || u.mutation instanceof Qn) ? i = i.insert(e.key, e) : void 0 !== u && (o.set(e.key, u.mutation.getFieldMask()), 
            Bn(u.mutation, e, u.mutation.getFieldMask(), ot.now()));
        })), this.recalculateAndSaveOverlays(t, i).next((function(t) {
            return t.forEach((function(t, e) {
                return o.set(t, e);
            })), e.forEach((function(t, e) {
                var n;
                return u.set(t, new Ho(e, null !== (n = o.get(t)) && void 0 !== n ? n : null));
            })), u;
        }));
    }, t.prototype.recalculateAndSaveOverlays = function(t, e) {
        var n = this, r = lr(), i = new Gt((function(t, e) {
            return t - e;
        })), o = dr();
        return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            for (var n = function(t) {
                t.keys().forEach((function(n) {
                    var o = e.get(n);
                    if (null !== o) {
                        var u = r.get(n) || Ht.empty();
                        u = t.applyToLocalView(o, u), r.set(n, u);
                        var s = (i.get(t.batchId) || dr()).add(n);
            ...
            for (var u = [], s = i.getReverseIterator(), a = function() {
                var i = s.getNext(), a = i.key, c = i.value, l = cr();
 ...
 */
    ...
    t.prototype.getNextDocuments = function(t, e, n, r) {
        ...
        return this.remoteDocumentCache.getAllFromCollectionGroup(t, e, n, r).next((function(o) {
            var u = r - o.size > 0 ? i.documentOverlayCache.getOverlaysForCollectionGroup(t, e, n.largestBatchId, r - o.size) : xt.resolve(ar()), s = -1, a = o;
            ...
            // the batch id.
                ...
                return xt.forEach(e, (function(e, n) {
                    ...
                    return i.computeViews(t, a, e, dr());
                })).next((function(t) {
                    return {
                        batchId: s,
                        changes: sr(t)
        ...
        var r = this, i = e.collectionGroup, o = ur();
        ...
        // Query the remote documents and overlay mutations.
            ...
            t.forEach((function(t, e) {
                var n = e.getKey();
                null === r.get(n) && (r = r.insert(n, Oe.newInvalidDocument(n)));
            }));
            // Apply the overlays and match against the query.
            var n = ur();
            return r.forEach((function(r, i) {
                var o = t.get(r);
                void 0 !== o && Bn(o.mutation, i, Ht.empty(), ot.now()), 
                // Finally, insert the documents that still match the query
                vn(e, i) && (n = n.insert(r, i));
            })), n;
        }));
    }, 
    /** Returns a base document that can be used to apply `overlay`. */ t.prototype.getBaseDocument = function(t, e, n) {
        return null === n || 1 /* Patch */ === n.mutation.type ? this.remoteDocumentCache.getEntry(t, e) : xt.resolve(Oe.newInvalidDocument(e));
    }, t;
}(), Xo = /** @class */ function() {
    function t(t) {
    ...
    function t() {
        ...
        this.overlays = new Gt(ht.comparator), this.es = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        ...
        for (var r = ar(), i = e.length + 1, o = new ht(e.child("")), u = this.overlays.getIteratorFrom(o); u.hasNext(); ) {
        ...
        for (var i = new Gt((function(t, e) {
            ...
            if (u.getKey().getCollectionGroup() === e && u.largestBatchId > n) {
                ...
                null === s && (s = ar(), i = i.insert(u.largestBatchId, s)), s.set(u.getKey(), u);
            }
        }
        for (var a = ar(), c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return a.set(t, e);
        })), !(a.size() >= r)); ) ;
        return xt.resolve(a);
        ...
        var o = this.es.get(e);
        void 0 === o && (o = dr(), this.es.set(e, o)), this.es.set(e, o.add(n.key));
    }, t;
}(), Jo = /** @class */ function() {
    function t() {
    ...
    t.prototype.ls = function(t) {
        var e = this, n = new ht(new at([])), r = new $o(n, t), i = new $o(n, t + 1), o = [];
        ...
        var e = new ht(new at([])), n = new $o(e, t), r = new $o(e, t + 1), i = dr();
        return this.rs.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new $o(t, 0), n = this.ns.firstAfterOrEqual(e);
    ...
    return t.ss = function(t, e) {
        return ht.comparator(t.key, e.key) || nt(t._s, e._s);
    }, 
    /** Compare by ID then by key */ t.os = function(t, e) {
        return nt(t._s, e._s) || ht.comparator(t.key, e.key);
    }, t;
}(), tu = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new ki(i, e, n, r);
        this.mutationQueue.push(o);
        // Track references by document key and index collection parents.
        for (var u = 0, s = r; u < s.length; u++) {
            var a = s[u];
            this.gs = this.gs.add(new $o(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return xt.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        ...
        var n = this, r = new $o(e, 0), i = new $o(e, Number.POSITIVE_INFINITY), o = [];
        return this.gs.forEachInRange([ r, i ], (function(t) {
            var e = n.ys(t._s);
            o.push(e);
        })), xt.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new Qt(nt);
        return e.forEach((function(t) {
            var e = new $o(t, 0), i = new $o(t, Number.POSITIVE_INFINITY);
        ...
        var o = new $o(new ht(i), 0), u = new Qt(nt);
        ...
        var n = new $o(e, 0), r = this.gs.firstAfterOrEqual(n);
    ...
    function t(t) {
        ...
        this.docs = new Gt(ht.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return xt.resolve(n ? n.document.mutableCopy() : Oe.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = ir();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : Oe.newInvalidDocument(t));
        })), xt.resolve(r);
    }, t.prototype.getAllFromCollection = function(t, e, n) {
        for (var r = ir(), i = new ht(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var u = o.getNext(), s = u.key, a = u.value.document;
            if (!e.isPrefixOf(s.path)) break;
            s.path.length > e.length + 1 || Et(bt(a), n) <= 0 || (r = r.insert(a.key, a.mutableCopy()));
        }
        return xt.resolve(r);
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
...
}(qo), ru = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Rs = new nr((function(t) {
            return Re(t);
        }), Me), 
        ...
        /**
             ...
             * IDs.
             */
        this.Ps = new Jo, this.targetCount = 0, this.vs = No.Pn();
    }
    ...
    function t(t, e) {
        var n = this;
        this.Vs = {}, this.overlays = {}, this.Ss = new Ft(0), this.Ds = !1, this.Ds = !0, 
        this.referenceDelegate = t(this), this.Cs = new ru(this), this.indexManager = new co, 
        this.remoteDocumentCache = new eu((function(t) {
            return n.referenceDelegate.xs(t);
        })), this.It = new Ri(e), this.Ns = new Xo(this.It);
    }
    return t.prototype.start = function() {
        ...
        return e || (e = new Zo, this.overlays[t.toKey()] = e), e;
     ...
     */    return t.prototype.$ = function(t, e, n, r) {
        var i = this, o = new _t("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore("mutationQueues", {
                ...
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", ui, {
                unique: !0
        ...
        u = u.next((function() {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", Ei, {
                    unique: !1
                }), e.createIndex("collectionGroupOverlayIndex", Ti, {
                    unique: !1
                });
            }(t);
            ...
            return function(t) {
                ...
                e.createIndex("documentKeyIndex", hi), e.createIndex("collectionGroupIndex", fi);
            }(t);
        })).next((function() {
            return i.Ws(t, o);
        })).next((function() {
            ...
            return function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: mi
                }).createIndex("sequenceNumberIndex", gi, {
                    unique: !1
            ...
            return xt.forEach(n, (function(n) {
                ...
                return r.W("userMutationsIndex", i).next((function(r) {
                    return xt.forEach(r, (function(r) {
                        q(r.userId === n.userId);
                        var i = Ui(e.It, r);
                        return Io(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.Gs = function(t) {
        ...
        return n.Z((function(t, r) {
            var i = Bi(r), o = Gi(e.It, i);
            return n.put(o);
        }));
    }, t.prototype.Ws = function(t, e) {
        var n = e.store("remoteDocuments"), r = [];
        return n.Z((function(t, n) {
            var i, o = e.store("remoteDocumentsV14"), u = (i = n, i.document ? new ht(at.fromString(i.document.name).popFirst(5)) : i.noDocument ? ht.fromSegments(i.noDocument.path) : i.unknownDocument ? ht.fromSegments(i.unknownDocument.path) : F()).path.toArray(), s = {
        ...
        var n = this, r = e.store("mutations"), i = Bo(this.It), o = new iu(uu.Bs, this.It.re);
        return r.W().next((function(t) {
            var r = new Map;
            return t.forEach((function(t) {
                var e, i = null !== (e = r.get(t.userId)) && void 0 !== e ? e : dr();
                Ui(n.It, t).keys().forEach((function(t) {
                    return i = i.add(t);
                })), r.set(t.userId, i);
            })), xt.forEach(r, (function(t, r) {
                var u = new A(r), s = Xi.oe(n.It, u), a = o.getIndexManager(u), c = To.oe(u, n.It, a, o.referenceDelegate);
                return new Yo(i, c, s, a).recalculateAndSaveOverlaysForDocumentKeys(new Ai(e, Ft.at), t).next();
            }));
        }));
    }, t;
}();
 ...
 */ function au(t) {
    t.createObjectStore("targetDocuments", {
        keyPath: pi
    }).createIndex("documentTargetsIndex", vi, {
        unique: !0
    }), 
...
var cu = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", lu = /** @class */ function() {
    function t(
    /**
    ...
    l, h) {
        ...
        this.si = function(t) {
            return Promise.resolve();
        }, !t.C()) throw new K(G.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Po(this, i), this.ii = n + "main", this.It = new Ri(a), 
        this.ri = new Nt(this.ii, this.Xs, new su(this.It)), this.Cs = new Ao(this.referenceDelegate, this.It), 
        this.remoteDocumentCache = Bo(this.It), this.Ns = new Wi, this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, 
        !1 === l && R("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new K(G.FAILED_PRECONDITION, cu);
    ...
    t.prototype.ui = function() {
        ...
        var e = this;
        return hu(t).get("owner").next((function(t) {
            return xt.resolve(e.mi(t));
        }));
    }, t.prototype.gi = function(t) {
        return fu(t).delete(this.clientId);
    }, 
    /**
    ...
    t.prototype.di = function(t) {
        var e = this;
        return this.Ys ? xt.resolve(!0) : hu(t).get("owner").next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || fu(t).W().next((function(t) {
    ...
    t.prototype.vi = function() {
        ...
        return To.oe(t, this.It, e, this.referenceDelegate);
    }, t.prototype.getTargetCache = function() {
        return this.Cs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.remoteDocumentCache;
    }, t.prototype.getIndexManager = function(t) {
        return new fo(t, this.It.re.databaseId);
    }, t.prototype.getDocumentOverlayCache = function(t) {
        return Xi.oe(this.It, t);
    }, t.prototype.getBundleCache = function() {
        return this.Ns;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        L("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, u = "readonly" === e ? "readonly" : "readwrite", s = 15 === (i = this.Xs) ? Ni : 14 === i ? _i : 13 === i ? xi : 12 === i ? Di : 11 === i ? Si : void F();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.ri.runTransaction(t, u, s, (function(i) {
            return o = new Ai(i, r.Ss ? r.Ss.next() : Ft.at), "readwrite-primary" === e ? r.fi(o).next((function(t) {
                return !!t || r.di(o);
            })).next((function(e) {
                if (!e) throw R("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Hs.enqueueRetryable((function() {
                    return r.si(!1);
                })), new K(G.FAILED_PRECONDITION, Tt);
                return n(o);
            })).next((function(t) {
    ...
    t.prototype.Vi = function(t) {
        var e = this;
        return hu(t).get("owner").next((function(t) {
            if (null !== t && e.pi(t.leaseTimestampMs, 5e3) && !e.Ei(t.ownerId) && !e.mi(t) && !(e.Ys || e.allowTabSynchronization && t.allowTabSynchronization)) throw new K(G.FAILED_PRECONDITION, cu);
        }));
    }, 
    /**
...
var pu = /** @class */ function() {
    ...
    t.prototype.ki = function(t, e) {
        ...
        return this.indexManager.getIndexType(t, r).next((function(i) {
            ...
            e = hn(e, null, "F" /* First */), r = ln(e)), n.indexManager.getDocumentsMatchingTarget(t, r).next((function(i) {
                ...
                return n.Ni.getDocuments(t, o).next((function(i) {
                    return n.indexManager.getMinOffset(t, r).next((function(r) {
                        var u = n.Fi(e, i);
                        return n.$i(e, u, o, r.readTime) ? n.ki(t, hn(e, null, "F" /* First */)) : n.Bi(t, u, e, r);
                    }));
                }));
            })));
        }));
    ...
    t.prototype.Mi = function(t, e, n, r) {
        var i = this;
        return on(e) || r.isEqual(ut.min()) ? this.Oi(t, e) : this.Ni.getDocuments(t, n).next((function(o) {
            var u = i.Fi(e, o);
            return i.$i(e, u, n, r) ? i.Oi(t, e) : (O() <= h.DEBUG && L("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), pn(e)), 
            i.Bi(t, u, e, wt(r, -1)));
        }));
    ...
    t.prototype.$i = function(t, e, n, r) {
        ...
        return O() <= h.DEBUG && L("QueryEngine", "Using full collection scan to execute query:", pn(e)), 
        this.Ni.getDocumentsMatchingQuery(t, e, It.min());
    }, 
    /**
    ...
    return t.prototype.Qi = function(t) {
        ...
        this.mutationQueue = this.persistence.getMutationQueue(t, this.indexManager), this.localDocuments = new Yo(this.Gi, this.mutationQueue, this.documentOverlayCache, this.indexManager), 
...
function gu(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , (e = B(t)).persistence.runTransaction("Handle user change", "readonly", (function(t) {
 ...
 * queue.
 */ function Iu(t, e) {
    var n = B(t), r = e.snapshotVersion, i = n.Ui;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, s) {
            ...
            if (a) {
                ...
                e.targetMismatches.has(s) ? c = c.withResumeToken(Xt.EMPTY_BYTE_STRING, ut.min()).withLastLimboFreeSnapshotVersion(ut.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(s, c), 
...
function Du(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = B(t), o = e.Ui.get(r), u = i ? "readwrite" : "readwrite-primary", n.label = 1;
 ...
 */ function xu(t, e, n) {
    var r = B(t), i = ut.min(), o = dr();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = B(t), i = r.qi.get(n);
            ...
            return r.Li.getDocumentsMatchingQuery(t, e, n ? i : ut.min(), n ? o : dr());
        })).next((function(t) {
            return Au(r, yn(e), t), {
                documents: t,
                Hi: o
...
// PORTING NOTE: Multi-Tab only.
function _u(t, e) {
    var n = B(t), r = B(n.Cs), i = n.Ui.get(e);
 ...
 */ function Cu(t, r, i, o) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                for (e = B(t), u = dr(), s = ir(), a = 0, c = i; a < c.length; a++) l = c[a], h = r.Ji(l.metadata.name), 
                ...
                return d = e.Gi.newChangeBuffer({
                    ...
                    return ln(rn(at.fromString("__bundle__/docs/" + t)));
                }(o)) ];
 ...
 */ function ku(t, r, i) {
    return void 0 === i && (i = dr()), e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Su(t, ln(Ki(r.bundledQuery))) ];

              case 1:
                return e = n.sent(), [ 2 /*return*/ , (o = B(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    var n = kr(r.readTime);
                    // Simply save the query itself if it is older than what the SDK already
                    // has.
                                        if (e.snapshotVersion.compareTo(n) >= 0) return o.Ns.saveNamedQuery(t, r);
                    // Update existing target data because the query from the bundle is newer.
                                        var u = e.withResumeToken(Xt.EMPTY_BYTE_STRING, n);
...
/** Assembles the key for a client state in WebStorage */ function Ou(t, e) {
...
var Ru = /** @class */ function() {
    ...
    return t.Zi = function(e, n, r) {
        ...
        u ? new t(e, n, o.state, i) : (R("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.Zi = function(e, n) {
        ...
        o ? new t(e, i.state, r) : (R("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.tr = function() {
        var t = {
            state: this.state,
    ...
    return t.Zi = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = vr(), u = 0; i && u < r.activeTargetIds.length; ++u) i = ae(r.activeTargetIds[u]), 
        o = o.add(r.activeTargetIds[u]);
        return i ? new t(e, o) : (R("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), Fu = /** @class */ function() {
    function t(t, e) {
    ...
    return t.Zi = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (R("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), qu = /** @class */ function() {
    function t() {
        this.activeTargetIds = vr();
    }
    ...
    function t(t, e, n, r, i) {
        ...
        this.ur = new Gt(nt), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ar = Ou(this.persistenceKey, this.sr), 
        this.hr = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.C = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.sr && (o = this.getItem(Ou(this.persistenceKey, i))) && (u = Pu.Zi(i, o)) && (this.ur = this.ur.insert(u.clientId, u));
        ...
        // `Window.addEventListener`.
            ...
            if (L("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.ar) return void R("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                        ...
                        switch (n.label) {
                          ...
                          case 4:
                            return i.key !== this.hr ? [ 3 /*break*/ , 5 ] : (s = function(t) {
                                ...
                                return e;
                            }(i.newValue), s !== Ft.at && this.sequenceNumberHandler(s), [ 3 /*break*/ , 7 ]);
        ...
        var r = new Ru(this.currentUser, t, e, n), i = Vu(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.tr());
        ...
        var r = Lu(this.persistenceKey, t), i = new Mu(t, e, n);
        this.setItem(r, i.tr());
    ...
    return t(n, e), n.prototype.lo = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var u = new w;
            u.listenOnce(b.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case I.TIMEOUT:
                        L("Connection", 'RPC "' + t + '" timed out'), o(new K(G.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case I.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new K(s, r.message));
                            } else o(new K(G.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new K(G.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var r = [ this.oo, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = E(), o = T(), u = {
        ...
        this.useFetchStreams && (u.xmlHttpFactory = new S({})), this.ho(u.initMessageHeaders, e, n), 
        ...
        var a = i.createWebChannel(s, u), c = !1, l = !1, h = new Qu({
            Hr: function(t) {
        ...
        return f(a, D.EventType.OPEN, (function() {
            l || L("Connection", "WebChannel transport opened.");
        })), f(a, D.EventType.CLOSE, (function() {
            l || (l = !0, L("Connection", "WebChannel transport closed"), h.io());
        })), f(a, D.EventType.ERROR, (function(t) {
            l || (l = !0, M("Connection", "WebChannel transport errored:", t), h.io(new K(G.UNAVAILABLE, "The operation could not be completed")));
        })), f(a, D.EventType.MESSAGE, (function(t) {
            var e;
            if (!l) {
                var n = t.data[0];
                q(!!n);
 ...
 */
                    ...
                    void 0 === u && (u = G.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    l = !0, h.io(new K(u, s)), a.close();
                } else L("Connection", "WebChannel received:", n), h.ro(n);
            }
        })), f(o, x.STAT_EVENT, (function(t) {
            t.stat === _.PROXY ? L("Connection", "Detected buffering proxy") : t.stat === _.NOPROXY && L("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.co = function(t, e, n, r, i) {
        ...
        return this.ho(u, r, i), this.lo(t, o, u, n).then((function(t) {
            ...
            throw M("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
...
/** The Platform's 'document' implementation or null if not available. */ function Hu() {
 ...
 * limitations under the License.
 */ function Yu(t) {
    return new _r(t, /* useProto3Json= */ !0);
}
 ...
 */ var Xu = /** @class */ function() {
    ...
    t.prototype.Ao = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && L("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.po + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o, u, s) {
        ...
        /**
             ...
             * close.
             */
        this.So = 0, this.Do = null, this.Co = null, this.stream = null, this.xo = new Xu(t, e)
        /**
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.xo.reset() : r && r.code === G.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    R(r.toString()), R("Using maximum backoff delay to prevent overloading the backend."), 
                    this.xo.Eo()) : r && r.code === G.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.gt ? (q(void 0 === e || "string" == typeof e), Xt.fromBase64String(e || "")) : (q(void 0 === e || e instanceof Uint8Array), 
                    Xt.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = e.targetChange.cause, s = u && function(t) {
                    var e = void 0 === t.code ? G.UNKNOWN : er(t.code);
                    return new K(e, t.message || "");
                }(u);
                n = new br(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Rr(t, a.document.name), l = kr(a.document.updateTime), h = new Ce({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = Oe.newFoundDocument(c, l, h), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new gr(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = Rr(t, v.document), m = v.readTime ? kr(v.readTime) : ut.min(), g = Oe.newNoDocument(y, m), w = v.removedTargetIds || [];
                n = new gr([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Rr(t, b.document), E = b.removedTargetIds || [];
                n = new gr([], E, I, null);
            } else {
                ...
                var T = e.filter;
                T.targetId;
                var S = T.count || 0, D = new $n(S), x = T.targetId;
                n = new wr(x, D);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? ut.min() : e.readTime ? kr(e.readTime) : ut.min();
        }(t);
    ...
    n.prototype.zo = function(t) {
        var e = {};
        e.database = Fr(this.It), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Pe(r) ? {
                documents: jr(t, r)
            } : {
                query: Qr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Ar(t, e.resumeToken) : e.snapshotVersion.compareTo(ut.min()) > 0 && (
    ...
    n.prototype.Ho = function(t) {
        var e = {};
        e.database = Fr(this.It), e.removeTarget = t, this.Bo(e);
    }, n;
}(Zu), $u = /** @class */ function(e) {
    function n(t, n, r, i, o, u) {
        var s = this;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (q(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? kr(t.updateTime) : kr(e);
                        ...
                        n = kr(e)), new Rn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = kr(t.commitTime);
    ...
    n.prototype.eu = function() {
        ...
        var t = {};
        t.database = Fr(this.It), this.Bo(t);
    }, 
    ...
    return t(n, e), n.prototype.su = function() {
        if (this.nu) throw new K(G.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.ou ? (R(e), this.ou = !1) : L("OnlineStateTracker", e);
        ...
        i.enqueueAndForget((function() {
            return e(s, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return hs(this) ? (L("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = B(t))._u.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , is(e) ];
 ...
 */ function us(t, e) {
    var n = B(t), r = _s(n);
    n.du.delete(e), r.ko() && as(n, e), 0 === n.du.size && (r.ko() ? r.Fo() : hs(n) && 
...
function ls(t) {
    return hs(t) && !_s(t).No() && t.du.size > 0;
}
...
function vs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.gu.set("Online" /* Online */), !(r instanceof br && 2 /* Removed */ === r.state && r.cause)) 
              ...
              case 6:
                if (r instanceof gr ? t.yu.Gt(r) : r instanceof wr ? t.yu.Yt(r) : t.yu.Wt(r), i.isEqual(ut.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , bu(t.localStore) ];
              ...
              case 11:
                return L("RemoteStore", "Failed to raise snapshot:", s = a.sent()), [ 4 /*yield*/ , ys(t, s) ];
        ...
        return n(this, (function(u) {
            switch (u.label) {
              case 0:
                ...
                return t._u.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , is(t) ];
                    ...
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t._u.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , rs(t) ];
...
function gs(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = B(t), r = Ns(e), i = e.fu.length > 0 ? e.fu[e.fu.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Tu(e.localStore, i) ];
              ...
              case 4:
                return u = n.sent(), [ 4 /*yield*/ , ys(e, u) ];
...
function ws(t) {
    return hs(t) && !Ns(t).No() && t.fu.length > 0;
}
...
function Ts(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.fu.shift(), o = Oi.from(e, r, i), [ 4 /*yield*/ , ms(t, (function() {
                ...
                return r && Ns(t).Yo ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return tr(i = r.code) && i !== G.ABORTED ? (e = t.fu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ns(t).Oo(), [ 4 /*yield*/ , ms(t, (function() {
...
function Ds(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = B(t)).asyncQueue.verifyOperationInProgress(), L("RemoteStore", "RemoteStore received new credentials"), 
                i = hs(e), 
                // Tear down and re-create our network streams. This will ensure we get a
                // fresh auth token for the new user and re-fill the write pipeline with
                // new mutations from the LocalStore (since mutations are per-user).
                e._u.add(3 /* CredentialChange */), [ 4 /*yield*/ , is(e) ];
              ...
              case 2:
                return n.sent(), e._u.delete(3 /* CredentialChange */), [ 4 /*yield*/ , rs(e) ];
 ...
 */ function xs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = B(t), r ? (e._u.delete(2 /* IsSecondary */), [ 4 /*yield*/ , rs(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return r ? [ 3 /*break*/ , 4 ] : (e._u.add(2 /* IsSecondary */), [ 4 /*yield*/ , is(e) ]);
 ...
 */ function _s(t) {
    ...
    t.pu = function(t, e, n) {
        var r = B(t);
        return r.su(), new Ju(e, r.Vo, r.authCredentials, r.appCheckCredentials, r.It, n);
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.pu.Oo(), ls(t) ? cs(t) : t.gu.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Ns(t) {
    ...
    t.Iu = function(t, e, n) {
        var r = B(t);
        return r.su(), new $u(e, r.Vo, r.authCredentials, r.appCheckCredentials, r.It, n);
    }(t.datastore, t.asyncQueue, {
        Yr: Is.bind(null, t),
        Zr: Ss.bind(null, t),
        tu: Es.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Iu.Oo(), [ 4 /*yield*/ , gs(t) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Cs(t, e) {
    if (R("AsyncQueue", e + ": " + t), kt(t)) return new K(G.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ks = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = ur(), this.sortedSet = new Gt(this.comparator)
        /**
    ...
    this.queries = new nr((function(t) {
        return dn(t);
    }), fn), this.onlineState = "Unknown" /* Unknown */ , this.Ru = new Set;
};
 ...
 */ function Ms(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = B(t), i = r.query, o = !1, (u = e.queries.get(i)) || (o = !0, u = new Ls), 
                !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
              ...
              case 3:
                return a = n.sent(), c = Cs(a, "Initialization of query '" + pn(r.query) + "' failed"), 
                [ 2 /*return*/ , void r.onError(c) ];

              case 4:
                return e.queries.set(i, u), u.listeners.push(r), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                r.bu(e.onlineState), u.Au && r.Pu(u.Au) && Us(e), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Ps(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o, u, s;
        return n(this, (function(n) {
            return e = B(t), i = r.query, o = !1, (u = e.queries.get(i)) && (s = u.listeners.indexOf(r)) >= 0 && (u.listeners.splice(s, 1), 
...
function Fs(t, e) {
    for (var n = B(t), r = !1, i = 0, o = e; i < o.length; i++) {
 ...
 */ var Bs = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.bu = function(t) {
        ...
        t = Vs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Vu = !0, 
        this.vu.next(t);
    }, t;
}(), Gs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Yi = function(t) {
        return t.metadata.exists ? Br(this.It, t.document, !1) : Oe.newNoDocument(this.Ji(t.metadata.name), this.Xi(t.metadata.readTime));
    ...
    return t.prototype.Ou = function(t) {
        ...
        if (t.payload.namedQuery) this.queries.push(t.payload.namedQuery); else if (t.payload.documentMetadata) {
            ...
            var n = at.fromString(t.payload.documentMetadata.name);
    ...
    t.prototype.complete = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , Cu(this.localStore, new Ks(this.It), this.documents, this.Mu.id) ];

                  case 1:
                    t = n.sent(), e = this.Fu(this.documents), r = 0, i = this.queries, n.label = 2;

                  case 2:
                    return r < i.length ? (o = i[r], [ 4 /*yield*/ , ku(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var zs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = dr(), this.Ku = mn(t), this.Gu = new ks(this.Ku);
    }
    ...
    t.prototype.ju = function(t, e) {
        var n = this, r = e ? e.Wu : new Os, i = e ? e.Gu : this.Gu, o = e ? e.mutatedKeys : this.mutatedKeys, u = i, s = !1, a = "F" /* First */ === this.query.limitType && i.size === this.query.limit ? i.last() : null, c = "L" /* Last */ === this.query.limitType && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var l = i.get(t), h = vn(n.query, e) ? e : null, f = !!l && n.mutatedKeys.has(l.key), d = !!h && (h.hasLocalMutations || 
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.Uu = s, 0 !== o.length || a ? {
            snapshot: new Vs(this.query, t.Gu, i, o, t.mutatedKeys, 0 /* Local */ === s, a, 
            /* excludesMetadataChanges= */ !1),
            Yu: u
        } : {
            Yu: u
    ...
    t.prototype.Hu = function(t) {
        ...
        // updating many documents.
                var e = this.qu;
        this.qu = dr(), this.Gu.forEach((function(e) {
    ...
    t.prototype.tc = function() {
        return Vs.fromInitialDocuments(this.query, this.Gu, this.mutatedKeys, 0 /* Local */ === this.Uu);
    }, t;
}(), Ys = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.nc = {}, this.sc = new nr((function(t) {
            return dn(t);
        }), fn), this.ic = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.oc = new Gt(ht.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.uc = new Map, this.cc = new Jo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ac = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.hc = new Map, this.lc = No.vn(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , Su(e.localStore, ln(r)) ];

              case 2:
                return s = n.sent(), e.isPrimaryClient && os(e.remoteStore, s), a = e.sharedClientState.addLocalQueryTarget(s.targetId), 
                i = s.targetId, [ 4 /*yield*/ , $s(e, r, i, "current" === a) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(f) {
            switch (f.label) {
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.ju(i), e.$i ? [ 4 /*yield*/ , xu(t.localStore, r.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, u), [ 2 /*return*/ , (fa(t, r.targetId, s.Yu), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return u = f.sent(), s = new Hs(r, u.Hi), a = s.ju(u.documents), c = mr.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                l = s.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), fa(t, i, l.Yu), h = new Ys(r, i, s), 
...
/** Stops listening to the query. */ function ta(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = B(t), i = e.sc.get(r), (o = e.ic.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.ic.set(i.targetId, o.filter((function(t) {
                    return !fn(t, r);
                }))), void e.sc.delete(r)) ] : e.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                e.sharedClientState.removeLocalQueryTarget(i.targetId), e.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Du(e.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    e.sharedClientState.clearQueryState(i.targetId), us(e.remoteStore, i.targetId), 
                    la(e, i.targetId);
                })).catch(Dt) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return la(e, i.targetId), [ 4 /*yield*/ , Du(e.localStore, i.targetId, 
            ...
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r, i = B(t), o = ot.now(), u = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), dr());
                    return i.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        ...
                        return i.Gi.getEntries(t, u).next((function(t) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                var c = a[s], l = Gn(c, n.get(c.key).overlayedDocument);
                                null != l && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                u.push(new Qn(c.key, l, ke(l.value.mapValue), Mn.exists(!0)));
                            }
              ...
              case 2:
                return o = n.sent(), e.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new Gt(nt)), r = r.insert(e, n), t.ac[t.currentUser.toKey()] = r;
                }(e, o.batchId, i), [ 4 /*yield*/ , va(e, o.changes) ];

              case 3:
                return n.sent(), [ 4 /*yield*/ , gs(e.remoteStore) ];

              case 4:
                return n.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return u = n.sent(), s = Cs(u, "Failed to persist write"), i.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = B(t)).sharedClientState.updateQueryState(r, "rejected", i), o = e.uc.get(r), 
                (u = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                s = (s = new Gt(ht.comparator)).insert(u, Oe.newNoDocument(u, ut.min())), a = dr().add(u), 
                c = new yr(ut.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Qt(nt), s, a), [ 4 /*yield*/ , na(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.oc = e.oc.remove(u), e.uc.delete(r), pa(e), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , Du(e.localStore, r, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return la(e, r, i);
                })).catch(Dt) ];
...
function oa(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = B(t), i = r.batch.batchId, n.label = 1;
              ...
              case 2:
                ...
                ca(e, i, /*error=*/ null), aa(e, i), e.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , va(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                // listen events.
                ca(e, r, i), aa(e, r), e.sharedClientState.updateMutationState(r, "rejected", i), 
                [ 4 /*yield*/ , va(e, o) ];
 ...
 */ function sa(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                hs((e = B(t)).remoteStore) || L("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                n.label = 1;
              ...
              case 3:
                return u = n.sent(), s = Cs(u, "Initialization of waitForPendingWrites() operation failed"), 
...
function ca(t, e, n) {
    var r = B(t), i = r.ac[r.currentUser.toKey()];
...
function ha(t, e) {
    ...
    var n = t.oc.get(e);
    null !== n && (us(t.remoteStore, n), t.oc = t.oc.remove(e), t.uc.delete(n), pa(t));
}

function fa(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof zs ? (t.cc.addReference(o.key, e), da(t, o)) : o instanceof Ws ? (L("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function da(t, e) {
    ...
    t.oc.get(n) || t.rc.has(r) || (L("SyncEngine", "New document in limbo: " + n), t.rc.add(r), 
    pa(t));
}
 ...
 */ function pa(t) {
    for (;t.rc.size > 0 && t.oc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.rc.delete(e);
        var n = new ht(at.fromString(e)), r = t.lc.next();
        t.uc.set(r, new Xs(n)), t.oc = t.oc.insert(n, r), os(t.remoteStore, new Li(ln(rn(n.path)), r, 2 /* LimboResolution */ , Ft.at));
    }
}
...
function va(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = B(t), u = [], s = [], a = [], o.sc.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.sc.forEach((function(t, e) {
...
function ya(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return (e = B(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (L("SyncEngine", "User change. New user:", r.toKey()), 
                [ 4 /*yield*/ , gu(e.localStore, r) ]);
              ...
              case 1:
                ...
                e.sharedClientState.handleUserChange(r, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , va(e, i.ji) ];
...
function ma(t, e) {
    var n = B(t), r = n.uc.get(e);
    if (r && r.ec) return dr().add(r.key);
    var i = dr(), o = n.ic.get(e);
    if (!o) return i;
 ...
 */ function ga(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , xu((e = B(t)).localStore, r.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = n.sent(), o = r.view.Zu(i), [ 2 /*return*/ , (e.isPrimaryClient && fa(e, r.targetId, o.Yu), 
                o) ];
            }
        }));
    }));
...
function wa(t, r) {
    return e(this, void 0, void 0, (function() {
        var e;
        return n(this, (function(n) {
            return [ 2 /*return*/ , Nu((e = B(t)).localStore, r).then((function(t) {
                return va(e, t);
            })) ];
        }));
    }));
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return null === (u = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , gs(e.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                ca(e, r, o || null), aa(e, r), function(t, e) {
                    B(B(t).mutationQueue).An(e);
                }(e.localStore, r)) : F(), n.label = 4;

              case 4:
                return [ 4 /*yield*/ , va(e, u) ];
...
function Ia(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return _a(e = B(t)), Na(e), !0 !== r || !0 === e.fc ? [ 3 /*break*/ , 3 ] : (i = e.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , Ea(e, i.toArray()) ]);

              case 1:
                return o = n.sent(), e.fc = !0, [ 4 /*yield*/ , xs(e.remoteStore, !0) ];

              case 2:
                for (n.sent(), u = 0, s = o; u < s.length; u++) a = s[u], os(e.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                e.ic.forEach((function(t, n) {
                    e.sharedClientState.isLocalQueryTarget(n) ? c.push(n) : l = l.then((function() {
                        return la(e, n), Du(e.localStore, n, 
                        /*keepPersistedTargetData=*/ !0);
                    })), us(e.remoteStore, n);
                })), [ 4 /*yield*/ , l ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.uc.forEach((function(t, n) {
                        us(e.remoteStore, n);
                    })), e.cc.fs(), e.uc = new Map, e.oc = new Gt(ht.comparator);
                }(e), e.fc = !1, [ 4 /*yield*/ , xs(e.remoteStore, !1) ];
...
function Ea(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = B(t), i = [], o = [], u = 0, s = r, n.label = 1;

              case 1:
                return u < s.length ? (a = s[u], c = void 0, (l = e.ic.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , Su(e.localStore, ln(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = e.sc.get(d), [ 4 /*yield*/ , ga(e, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , _u(e.localStore, a) ];

              case 8:
                return y = n.sent(), [ 4 /*yield*/ , Su(e.localStore, y) ];

              case 9:
                return c = n.sent(), [ 4 /*yield*/ , $s(e, Ta(y), a, 
                /*current=*/ !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , Nu(e.localStore, yn(u[0])) ];

              case 2:
                return s = n.sent(), a = yr.createSynthesizedRemoteEventForCurrentChange(r, "current" === i), 
                [ 4 /*yield*/ , va(e, s, a) ];
              ...
              case 5:
                return n.sent(), la(e, r, o), [ 3 /*break*/ , 7 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function xa(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(e = _a(t)).fc) return [ 3 /*break*/ , 10 ];
                o = 0, u = r, p.label = 1;

              case 1:
                return o < u.length ? (s = u[o], e.ic.has(s) ? (
                // A target might have been added in a previous attempt
                L("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , _u(e.localStore, s) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , Su(e.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , $s(e, Ta(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), os(e.remoteStore, c), p.label = 5;
              ...
              case 6:
                l = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.ic.has(t) ? [ 4 /*yield*/ , Du(e.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                us(e.remoteStore, t), la(e, t);
                            })).catch(Dt) ] : [ 3 /*break*/ , 2 ];
...
function _a(t) {
    var e = B(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = na.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ma.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ia.bind(null, e), e.nc.Wo = Fs.bind(null, e.eventManager), 
    e.nc._c = qs.bind(null, e.eventManager), e;
}

function Na(t) {
    var e = B(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = oa.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ua.bind(null, e), 
    e
    /**
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    return i._updateProgress(Qs(e)), o = new js(e, t.localStore, r.It), [ 4 /*yield*/ , r.wc() ];
                  ...
                  case 11:
                    return a = n.sent(), [ 4 /*yield*/ , va(t, a.Bu, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 14:
                    return [ 2 /*return*/ , (M("SyncEngine", "Loading bundle failed with " + (c = n.sent())), 
...
var Ca = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.It = Yu(t.databaseInfo.databaseId), this.sharedClientState = this.mc(t), 
        ...
        return mu(this.persistence, new vu, t.initialUser, this.It);
    }, t.prototype.gc = function(t) {
        return new iu(uu.Bs, this.It);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , Na(this.Ec.syncEngine) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , gs(this.Ec.remoteStore) ];
        ...
        return new Ro(n, t.asyncQueue, e);
    }, i.prototype.Tc = function(t, e) {
        var n = new Pt(e, this.persistence);
        return new Mt(t.asyncQueue, n);
    }, i.prototype.gc = function(t) {
        var e = du(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? bo.withCacheSize(this.cacheSizeBytes) : bo.DEFAULT;
        return new lu(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Wu(), Hu(), this.It, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.mc = function(t) {
        return new Bu;
    }, i;
}(Ca), Oa = /** @class */ function(r) {
    function i(t, e) {
        var n = this;
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(u) {
                switch (u.label) {
                  ...
                  case 1:
                    return u.sent(), i = this.Ec.syncEngine, this.sharedClientState instanceof Uu ? (this.sharedClientState.syncEngine = {
                        Fr: ba.bind(null, i),
                        $r: Da.bind(null, i),
                        Br: xa.bind(null, i),
                        vi: Sa.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.li((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Ia(this.Ec.syncEngine, t) ];
        ...
        var e = Wu();
        if (!Uu.C(e)) throw new K(G.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = du(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Uu(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(ka), Va = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
                ...
                switch (n.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return ra(e.syncEngine, t, 1 /* SharedClientState */);
        ...
        var e, n = Yu(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new zu(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return ra(u.syncEngine, t, 0 /* RemoteStore */);
        }, o = Ku.C() ? new Ku : new Gu, new ns(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, u) {
            var s = new Zs(t, e, n, r, i, o);
            return u && (s.fc = !0), s;
        ...
        return function(t) {
            return e(this, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = B(t), L("RemoteStore", "RemoteStore shutting down."), e._u.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , is(e) ];
 ...
 */ var Ra = /** @class */ function() {
    ...
    return t.prototype.next = function(t) {
        ...
        this.observer.error ? this.Ac(this.observer.error, t) : R("Uncaught Error in snapshot listener:", t);
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = B(t), i = Fr(e.It) + "/documents", o = {
                                    ...
                                    return u = n.sent(), s = new Map, u.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Rr(t, e.found.name), r = kr(e.found.updateTime), i = new Ce({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Oe.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                q(!!e.missing), q(!!e.readTime);
                                                var n = Rr(t, e.missing), r = kr(e.readTime);
                                                return Oe.newNoDocument(n, r);
                                            }(t, e) : F();
                                        }(e.It, t);
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = ht.fromPath(e);
                        r.mutations.push(new Jn(n, r.precondition(n)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(ut.min()) ? Mn.exists(!1) : Mn.updateTime(e) : Mn.none();
    }, 
    /**
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this.Nc = n.maxAttempts, this.xo = new Xu(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.xo.Ao((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Pa(this.datastore), (e = this.Mc(t)) && e.then((function(e) {
        ...
        try {
            ...
            return !ue(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !tr(e);
        }
        return !1;
    }, t;
}(), qa = /** @class */ function() {
    ...
    i, o) {
        ...
        this.user = A.UNAUTHENTICATED, this.clientId = et.R(), this.authCredentialListener = function() {
            return Promise.resolve();
                ...
                return s.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return e(u, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , gu(r.localStore, t) ];
            ...
            switch (n.label) {
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return Ds(r.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, e) {
                    return Ds(r.remoteStore, e);
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return e = n.sent(), [ 2 /*return*/ , ((r = e.eventManager).onListen = Js.bind(null, e.syncEngine), 
                r.onUnlisten = ta.bind(null, e.syncEngine), r) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Ya(t, r, i) {
    var o = this;
    void 0 === i && (i = {});
    var u = new j;
 ...
 * limitations under the License.
 */ function Ja(t, e, n) {
    if (!n) throw new K(G.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 * @internal
 */ function $a(t, e, n, r) {
    if (!0 === e && !0 === r) throw new K(G.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function tc(t) {
    if (!ht.isDocumentKey(t)) throw new K(G.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function ec(t) {
    if (ht.isDocumentKey(t)) throw new K(G.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        ...
        var n = nc(t);
        throw new K(G.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function ic(t, e) {
    if (e <= 0) throw new K(G.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */
        return t = this, (e = Za.get(t)) && (L("ComponentProvider", "Removing Datastore"), 
...
function sc(t, e, n, r) {
    var i;
    void 0 === r && (r = {});
    var o = (t = rc(t, uc))._getSettings();
    if ("firestore.googleapis.com" !== o.host && o.host !== e && M("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    t._setSettings(Object.assign(Object.assign({}, o), {
        host: e + ":" + n,
        ssl: !1
    })), r.mockUserToken) {
        var u, s;
        if ("string" == typeof r.mockUserToken) u = r.mockUserToken, s = A.MOCK_USER; else {
            ...
            if (!a) throw new K(G.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            s = new A(a);
        }
        t._authCredentials = new W(new Q(u, s));
    }
}
 ...
 */ var ac = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, rn(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new ac(this.firestore, 
 ...
 */ function hc(t, e) {
    ...
    if (t = v(t), Ja("collection", "path", e), t instanceof uc) {
        var o = at.fromString.apply(at, r([ e ], n));
        return ec(o), new lc(t, /* converter= */ null, o);
    }
    if (!(t instanceof ac || t instanceof lc)) throw new K(G.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(at.fromString.apply(at, r([ e ], n)));
    return ec(u), new lc(t.firestore, 
    /* converter= */ null, u);
}
 ...
 */ function fc(t, e) {
    if (t = rc(t, uc), Ja("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new K(G.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new cc(t, 
    /* converter= */ null, 
    /**
...
function dc(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = et.R()), Ja("doc", "path", e), t instanceof uc) {
        var o = at.fromString.apply(at, r([ e ], n));
        return tc(o), new ac(t, 
        /* converter= */ null, new ht(o));
    }
    if (!(t instanceof ac || t instanceof lc)) throw new K(G.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(at.fromString.apply(at, r([ e ], n)));
    return tc(u), new ac(t.firestore, t instanceof lc ? t.converter : null, new ht(u));
}
 ...
 * Firestore database.
 */ function pc(t, e) {
    return t = v(t), e = v(e), (t instanceof ac || t instanceof lc) && (e instanceof ac || e instanceof lc) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function vc(t, e) {
    return t = v(t), e = v(e), t instanceof cc && e instanceof cc && t.firestore === e.firestore && fn(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var yc = /** @class */ function() {
    function t() {
        ...
        this.xo = new Xu(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.jc = function() {
            var e = Hu();
            e && L("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.xo.bo();
        };
        var e = Hu();
 ...
 */
                ...
                // and return the rejected Promise.
                                throw R("INTERNAL UNHANDLED ERROR: ", n), t;
            })).then((function(t) {
                return e.Kc = !1, t;
            }));
        }));
...
var gc = /** @class */ function() {
    ...
    return t(n, e), n.prototype._terminate = function() {
        ...
        Sc(this), this._firestoreClient.terminate();
    }, n;
}(uc);
 ...
 * @internal
 */ function Tc(t) {
    return t._firestoreClient || Sc(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function Sc(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new ie(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
 ...
 */ function Dc(t, e) {
    Rc(t = rc(t, bc));
    var n = Tc(t), r = t._freezeSettings(), i = new Va;
    return _c(n, i, new ka(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function xc(t) {
    Rc(t = rc(t, bc));
    var e = Tc(t), n = t._freezeSettings(), r = new Va;
    return _c(e, r, new Oa(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return e(o, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Ua(t, i) ];

                  case 1:
                    return n.sent(), [ 4 /*yield*/ , Ba(t, r) ];
         ...
         */
                    ...
                    return M("Error enabling offline persistence. Falling back to persistence disabled: " + o), 
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    }(du(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Cc(t) {
                    ...
                    switch (n.label) {
                      ...
                      case 2:
                        return r = n.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = B(t);
                            return e._u.delete(0 /* UserDisabled */), rs(e);
                        }(r)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Tc(t = rc(t, bc)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (r.setNetworkEnabled(!1), function(t) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = B(t))._u.add(0 /* UserDisabled */), [ 4 /*yield*/ , is(e) ];
...
function Lc(t, r) {
    ...
    }(Tc(t = rc(t, bc)), r).then((function(e) {
        return e ? new cc(t, null, e.query) : null;
    }));
}
...
}(), Bc = /^__.*__$/, Gc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Qn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new jn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Kc = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Qc = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.sa = function(e) {
        ...
        return hl(t, this.settings.methodName, this.settings.ha || !1, this.path, this.settings.la);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (jc(this.na) && Bc.test(t)) throw this.aa('Document fields cannot begin and end with "__"');
    }, t;
}(), zc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.It = n || Yu(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.fa = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Qc({
            na: t,
            methodName: e,
            la: n,
            path: lt.emptyPath(),
 ...
 * classes.
 */ function Wc(t) {
    var e = t._freezeSettings(), n = Yu(t._databaseId);
    return new zc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Hc(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.fa(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    sl("Data must be an object, but it was:", u, r);
    var s, a, c = ol(r, u);
    if (o.merge) s = new Ht(u.fieldMask), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var l = [], h = 0, f = o.mergeFields; h < f.length; h++) {
            var d = al(e, f[h], n);
            if (!u.contains(d)) throw new K(G.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            fl(l, d) || l.push(d);
        }
        s = new Ht(l), a = u.fieldTransforms.filter((function(t) {
            return s.covers(t.field);
        }));
    } else s = null, a = u.fieldTransforms;
    return new Gc(new Ce(c), s, a);
}
...
}(qc), tl = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this)._a = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new kn(t.It, In(t.It, this._a));
...
/** Parse update data from an update() call. */ function el(t, e, n, r) {
    var i = t.fa(1 /* Update */ , e, n);
    sl("Data must be an object, but it was:", i, r);
    var o = [], u = Ce.empty();
    Ut(r, (function(t, r) {
        var s = ll(e, t, n);
    ...
    var s = new Ht(o);
    return new Kc(u, s, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function nl(t, e, n, r, i, o) {
    var u = t.fa(1 /* Update */ , e, n), s = [ al(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new K(G.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(al(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], h = Ce.empty(), f = s.length - 1; f >= 0; --f) if (!fl(l, s[f])) {
        var d = s[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = v(p);
    ...
    var g = new Ht(l);
    return new Kc(h, g, u.fieldTransforms);
}
 ...
 */ function rl(t, e, n, r) {
    return void 0 === r && (r = !1), il(n, t.fa(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function il(t, e) {
    ...
    // from firestore-exp.
    t = v(t))) return sl("Unsupported field value:", e, t), ol(t, e);
    if (t instanceof qc) 
    ...
    return function(t, e) {
        ...
        if (!jc(e.na)) throw e.aa(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return In(e.It, t);
        ...
        if (t instanceof Fc) return {
            bytesValue: Ar(e.It, t._byteString)
        };
        if (t instanceof ac) {
            ...
            return {
                referenceValue: Or(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.aa("Unsupported field value: " + nc(t));
    }(t, e);
}
...
function ol(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Ut(t, (function(t, r) {
        var i = il(r, e.ia(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function ul(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ot || t instanceof Uc || t instanceof Fc || t instanceof ac || t instanceof qc);
}
 ...
 */ function al(t, e, n) {
    ...
    // FieldPath.
    (e = v(e)) instanceof Mc) return e._internalPath;
    if ("string" == typeof e) return ll(t, e);
    throw hl("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function ll(t, e, n) {
    if (e.search(cl) >= 0) throw hl("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (Mc.bind.apply(Mc, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
        throw hl("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}
...
function hl(t, e, n, r, i) {
    ...
    a += ")"), new K(G.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var dl = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new pl(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(vl("DocumentSnapshot.get", t));
 ...
 */
function vl(t, e) {
    return "string" == typeof e ? ll(t, e) : e instanceof Mc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var yl = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new gl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(vl("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(dl), gl = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(ml), wl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new yl(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new gl(n._firestore, n._userDataWriter, r.key, r, new yl(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new gl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new yl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new gl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new yl(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 * limitations under the License.
 */ function El(t) {
    if ("L" /* Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new K(G.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Dl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Wc(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new K(G.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Ul(u, o), 
            s = rl(n, "where", u, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = Be.create(i, o, s);
            return function(t, e) {
                if (e.dt()) {
                    var n = sn(t);
                    if (null !== n && !n.isEqual(e.field)) throw new K(G.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = un(t);
                    null !== r && Bl(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new K(G.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new K(G.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, f), f;
        }(t._query, 0, e, t.firestore._databaseId, this.wa, this.ma, this.ga);
        return new cc(t.firestore, t.converter, function(t, e) {
...
var Al = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new cc(t.firestore, t.converter, hn(t._query, this.pa, this.Ia));
    }, n;
}(Tl);
 ...
 * @returns The created {@link Query}.
 */ function Cl(t) {
    return ic("limit", t), new Al("limit", t, "F" /* First */)
    /**
...
function kl(t) {
    return ic("limitToLast", t), new Al("limitToLast", t, "L" /* Last */);
}
...
var Ol = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Fl(t, this.type, this.Ta, this.Ea);
        return new cc(t.firestore, t.converter, function(t, e) {
...
function Vl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Ol("startAt", t, 
    /*inclusive=*/ !0);
}

function Ll() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Ol("startAfter", t, 
    /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Fl(t, e, n, r) {
    if (n[0] = v(n[0]), n[0] instanceof dl) return function(t, e, n, r, i) {
        if (!r) throw new K(G.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], u = 0, s = cn(t); u < s.length; u++) {
            var a = s[u];
            if (a.field.isKeyField()) o.push(ge(e, r.key)); else {
                var c = r.data.field(a.field);
                if (ee(c)) throw new K(G.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var l = a.field.canonicalString();
                    throw new K(G.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + l + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Wc(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var u = t.explicitOrderBy;
        if (i.length > u.length) throw new K(G.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.isKeyField()) {
                if ("string" != typeof c) throw new K(G.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!an(t) && -1 !== c.indexOf("/")) throw new K(G.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var l = t.path.child(at.fromString(c));
                if (!ht.isDocumentKey(l)) throw new K(G.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by documentId(), the value passed to " + r + "() must result in a valid document path, but '" + l + "' is not because it contains an odd number of segments.");
                var h = new ht(l);
                s.push(ge(e, h));
            } else {
                var f = rl(n, r, c);
...
function ql(t, e, n) {
    if ("string" == typeof (n = v(n))) {
        ...
        if (!an(e) && -1 !== n.indexOf("/")) throw new K(G.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(at.fromString(n));
        if (!ht.isDocumentKey(r)) throw new K(G.INVALID_ARGUMENT, "Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return ge(t, new ht(r));
    }
    if (n instanceof ac) return ge(t, n._key);
    throw new K(G.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + nc(n) + ".");
}
 ...
 * array requirements.
 */ function Ul(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new K(G.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new K(G.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Bl(t, e, n) {
    if (!n.isEqual(e)) throw new K(G.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var Gl = {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Uc($t(t.latitude), $t(t.longitude));
        ...
        var n = at.fromString(t);
        q(ei(n));
        var r = new oe(n.get(1), n.get(3)), i = new ht(n.popFirst(5));
        return r.isEqual(e) || 
        // TODO(b/64130202): Somehow support foreign references.
        R("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}();
...
var Ql = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.convertBytes = function(t) {
        ...
        return new ac(this.firestore, /* converter= */ null, e);
    }, n;
}(Kl), zl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Wc(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Wl(t, this._firestore), i = jl(r.converter, e, n), o = Hc(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Mn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = Wl(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = v(e)) || e instanceof Mc ? nl(this._dataReader, "WriteBatch.update", u._key, e, n, r) : el(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, Mn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Wl(t, this._firestore);
        return this._mutations = this._mutations.concat(new Zn(e._key, Mn.none())), this;
    }, 
    /**
 ...
 */ function Hl(t) {
    t = rc(t, ac);
    var e = rc(t.firestore, bc);
    return Ya(Tc(e), t._key).then((function(n) {
        return ah(e, t, n);
    }));
}
 ...
 */ function Xl(t) {
    t = rc(t, ac);
    var r = rc(t.firestore, bc), i = Tc(r), o = new Yl(r);
    return function(t, r) {
        var i = this, o = new j;
        return t.asyncQueue.enqueueAndForget((function() {
            return e(i, void 0, void 0, (function() {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 2:
                                        return o = n.sent(), u = Cs(o, "Failed to get document '" + r + " from cache"), 
        ...
        return new ml(r, o, t._key, e, new yl(null !== e && e.hasLocalMutations, 
 ...
 */ function Jl(t) {
    t = rc(t, cc);
    var e = rc(t.firestore, bc), n = Tc(e), r = new Yl(e);
    return El(t._query), Xa(n, t._query).then((function(n) {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return e = n.sent(), o = new Hs(r, e.Hi), u = o.ju(e.documents), s = o.applyChanges(u, 
                                        /* updateLimboDocuments= */ !1), i.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = Cs(a, "Failed to execute query '" + r + " against cache"), 
...
function eh(t, e, n) {
    t = rc(t, ac);
    var r = rc(t.firestore, bc), i = jl(t.converter, e, n);
    return sh(r, [ Hc(Wc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Mn.none()) ]);
}

function nh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = rc(t, ac);
    var o = rc(t.firestore, bc), u = Wc(o);
    return sh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = v(e)) || e instanceof Mc ? nl(u, "updateDoc", t._key, e, n, r) : el(u, "updateDoc", t._key, e)).toMutation(t._key, Mn.exists(!0)) ]);
}
 ...
 */ function rh(t) {
    return sh(rc(t.firestore, bc), [ new Zn(t._key, Mn.none()) ]);
}
 ...
 */ function ih(t, e) {
    var n = rc(t.firestore, bc), r = dc(t), i = jl(t.converter, e);
    return sh(n, [ Hc(Wc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Mn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function oh(t) {
    ...
    "object" != typeof u[c] || mc(u[c]) || (a = u[c], c++);
    var l, h, f, d = {
    ...
    if (t instanceof ac) h = rc(t.firestore, bc), f = rn(t._key.path), l = {
        next: function(e) {
            u[c] && u[c](ah(h, t, e));
        },
        error: u[c + 1],
        ...
        var y = rc(t, cc);
        h = rc(y.firestore, bc), f = y._query;
        var m = new Yl(h);
        l = {
            next: function(t) {
    ...
    return function(t, r, i, o) {
        var u = this, s = new Ra(o), a = new Bs(r, s, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return e(u, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
 ...
 */ function ah(t, e, n) {
    var r = n.docs.get(e._key), i = new Yl(t);
    return new ml(t, i, e._key, r, new yl(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var ch, lh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Wl(t, this._firestore), i = new Yl(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new ml(n._firestore, i, r._key, t._document, new yl(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Wc(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Wl(t, this._firestore), r = new Ql(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return F();
            var i = t[0];
            if (i.isFoundDocument()) return new dl(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new dl(e._firestore, r, n._key, null, n.converter);
            throw F();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Wl(t, this._firestore), i = jl(r.converter, e, n), o = Hc(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = v(e)) || e instanceof Mc ? nl(this._dataReader, "Transaction.update", u._key, e, n, r) : el(this._dataReader, "Transaction.update", u._key, e), 
 ...
 */ function hh(t, r, i) {
    t = rc(t, bc);
    var o = Object.assign(Object.assign({}, Gl), i);
    return function(t) {
            ...
            return e(o, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), new Fa(t.asyncQueue, e, i, r, u).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), u.promise;
 ...
 * writes.
 */ function mh(t) {
    return Tc(t = rc(t, bc)), new zl(t, (function(e) {
        return sh(t, e);
    }))
    /**
 * @license
...
function gh(t, i) {
    var o, u = Tc(t = rc(t, bc));
    // PORTING NOTE: We don't return an error if the user has not enabled
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
    if (!(null === (o = u.offlineComponents) || void 0 === o ? void 0 : o.indexBackfillerScheduler)) return M("Cannot enable indexes when persistence is disabled"), 
    Promise.resolve();
    var s = function(t) {
        var e = "string" == typeof t ? function(t) {
            ...
            try {
                ...
                throw new K(G.INVALID_ARGUMENT, "Failed to parse JSON: " + (null === (e = t) || void 0 === e ? void 0 : e.message));
            }
        }(t) : t, n = [];
        if (Array.isArray(e.indexes)) for (var r = 0, i = e.indexes; r < i.length; r++) {
            var o = i[r], u = wh(o, "collectionGroup"), s = [];
            if (Array.isArray(o.fields)) for (var a = 0, c = o.fields; a < c.length; a++) {
                var l = c[a], h = ll("setIndexConfiguration", wh(l, "fieldPath"));
                "CONTAINS" === l.arrayConfig ? s.push(new yt(h, 2 /* CONTAINS */)) : "ASCENDING" === l.order ? s.push(new yt(h, 0 /* ASCENDING */)) : "DESCENDING" === l.order && s.push(new yt(h, 1 /* DESCENDING */));
            }
            n.push(new ft(ft.UNKNOWN_ID, u, s, gt.empty()));
        }
        return n;
    }(i);
    return Qa(u).then((function(t) {
        return function(t, i) {
            return e(this, void 0, void 0, (function() {
                var e, o, u;
                return n(this, (function(n) {
                    return e = B(t), o = e.indexManager, u = [], [ 2 /*return*/ , e.persistence.runTransaction("Configure indexes", "readwrite", (function(t) {
 ...
 */ void 0 === ch && (ch = !0), C = i, o(new c("firestore", (function(t, e) {
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new bc(new H(t.getProvider("auth-internal")), new J(t.getProvider("app-check-internal")), function(t, e) {
